...
`)+`
`+f);let b=w+m+a,S=w+f+o,E=Ng(r,r.VERTEX_SHADER,b),T=Ng(r,r.FRAGMENT_SHADER,S);r.attachShader(_,E),r.attachShader(_,T),t.index0AttributeName!==void 0?r.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(_,0,"position"),r.linkProgram(_);function R(I){if(n.debug.checkShaderErrors){let F=r.getProgramInfoLog(_)||"",U=r.getShaderInfoLog(E)||"",O=r.getShaderInfoLog(T)||"",X=F.trim(),G=U.trim(),k=O.trim(),Z=!0,le=!0;if(r.getProgramParameter(_,r.LINK_STATUS)===!1)if(Z=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(r,_,E,T);else{let ne=Ug(r,E,"vertex"),ce=Ug(r,T,"fragment");Pe("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(_,r.VALIDATE_STATUS)+`
...
Program Info Log: `+X+`
`+ne+`
`+ce)}else X!==""?Ue("WebGLProgram: Program Info Log:",X):(G===""||k==="")&&(le=!1);le&&(I.diagnostics={runnable:Z,programLog:X,vertexShader:{log:G,prefix:m},fragmentShader:{log:k,prefix:f}})}r.deleteShader(E),r.deleteShader(T),C=new ts(r,_),x=eb(r,_)}let C;this.getUniforms=function(){return C===void 0&&R(this),C};let x;this.getAttributes=function(){return x===void 0&&R(this),x};let M=t.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return M===!1&&(M=r.getProgramParameter(_,WS)),M},this.destroy=function(){i.releaseStatesOfProgram(this),r.deleteProgram(_),this.program=void 0},this.type=t.shaderType,this.name=t.shaderName,this.id=XS++,this.cacheKey=e,this.usedTimes=1,this.program=_,this.vertexShader=E,this.fragmentShader=T,this}var gb=0,$u=class{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e){let t=e.vertexShader,i=e.fragmentShader,r=this._getShaderStage(t),s=this._getShaderStage(i),a=this._getShaderCacheForMaterial(e);return a.has(r)===!1&&(a.add(r),r.usedTimes++),a.has(s)===!1&&(a.add(s),s.usedTimes++),this}remove(e){let t=this.materialCache.get(e);for(let i of t)i.usedTimes--,i.usedTimes===0&&this.shaderCache.delete(i.code);return this.materialCache.delete(e),this}getVertexShaderID(e){return this._getShaderStage(e.vertexShader).id}getFragmentShaderID(e){return this._getShaderStage(e.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){let t=this.materialCache,i=t.get(e);return i===void 0&&(i=new Set,t.set(e,i)),i}_getShaderStage(e){let t=this.shaderCache,i=t.get(e);return i===void 0&&(i=new ju(e),t.set(e,i)),i}},ju=class{constructor(e){this.id=gb++,this.code=e,this.usedTimes=0}};function vb(n,e,t,i,r,s,a){let o=new Ys,l=new $u,c=new Set,h=[],u=new Map,d=r.logarithmicDepthBuffer,p=r.precision,g={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distance",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function _(x){return c.add(x),x===0?"uv":`uv${x}`}function m(x,M,I,F,U){let O=F.fog,X=U.geometry,G=x.isMeshStandardMaterial?F.environment:null,k=(x.isMeshStandardMaterial?t:e).get(x.envMap||G),Z=k&&k.mapping===sa?k.image.height:null,le=g[x.type];x.precision!==null&&(p=r.getMaxPrecision(x.precision),p!==x.precision&&Ue("WebGLProgram.getParameters:",x.precision,"not supported, using",p,"instead."));let ne=X.morphAttributes.position||X.morphAttributes.normal||X.morphAttributes.color,ce=ne!==void 0?ne.length:0,ke=0;X.morphAttributes.position!==void 0&&(ke=1),X.morphAttributes.normal!==void 0&&(ke=2),X.morphAttributes.color!==void 0&&(ke=3);let De,tt,Ze,Y;if(le){let st=Wn[le];De=st.vertexShader,tt=st.fragmentShader}else De=x.vertexShader,tt=x.fragmentShader,l.update(x),Ze=l.getVertexShaderID(x),Y=l.getFragmentShaderID(x);let J=n.getRenderTarget(),pe=n.state.buffers.depth.getReversed(),Le=U.isInstancedMesh===!0,fe=U.isBatchedMesh===!0,Ge=!!x.map,ut=!!x.matcap,Ne=!!k,Ae=!!x.aoMap,we=!!x.lightMap,Me=!!x.bumpMap,qe=!!x.normalMap,P=!!x.displacementMap,nt=!!x.emissiveMap,Xe=!!x.metalnessMap,Ye=!!x.roughnessMap,de=x.anisotropy>0,A=x.clearcoat>0,v=x.dispersion>0,L=x.iridescence>0,q=x.sheen>0,$=x.transmission>0,W=de&&!!x.anisotropyMap,ve=A&&!!x.clearcoatMap,ee=A&&!!x.clearcoatNormalMap,_e=A&&!!x.clearcoatRoughnessMap,Re=L&&!!x.iridescenceMap,K=L&&!!x.iridescenceThicknessMap,se=q&&!!x.sheenColorMap,ye=q&&!!x.sheenRoughnessMap,Se=!!x.specularMap,re=!!x.specularColorMap,He=!!x.specularIntensityMap,D=$&&!!x.transmissionMap,ue=$&&!!x.thicknessMap,te=!!x.gradientMap,me=!!x.alphaMap,Q=x.alphaTest>0,j=!!x.alphaHash,ie=!!x.extensions,Oe=Tn;x.toneMapped&&(J===null||J.isXRRenderTarget===!0)&&(Oe=n.toneMapping);let ct={shaderID:le,shaderType:x.type,shaderName:x.name,vertexShader:De,fragmentShader:tt,defines:x.defines,customVertexShaderID:Ze,customFragmentShaderID:Y,isRawShaderMaterial:x.isRawShaderMaterial===!0,glslVersion:x.glslVersion,precision:p,batching:fe,batchingColor:fe&&U._colorsTexture!==null,instancing:Le,instancingColor:Le&&U.instanceColor!==null,instancingMorph:Le&&U.morphTexture!==null,outputColorSpace:J===null?n.outputColorSpace:J.isXRRenderTarget===!0?J.texture.colorSpace:ir,alphaToCoverage:!!x.alphaToCoverage,map:Ge,matcap:ut,envMap:Ne,envMapMode:Ne&&k.mapping,envMapCubeUVHeight:Z,aoMap:Ae,lightMap:we,bumpMap:Me,normalMap:qe,displacementMap:P,emissiveMap:nt,normalMapObjectSpace:qe&&x.normalMapType===dg,normalMapTangentSpace:qe&&x.normalMapType===ug,metalnessMap:Xe,roughnessMap:Ye,anisotropy:de,anisotropyMap:W,clearcoat:A,clearcoatMap:ve,clearcoatNormalMap:ee,clearcoatRoughnessMap:_e,dispersion:v,iridescence:L,iridescenceMap:Re,iridescenceThicknessMap:K,sheen:q,sheenColorMap:se,sheenRoughnessMap:ye,specularMap:Se,specularColorMap:re,specularIntensityMap:He,transmission:$,transmissionMap:D,thicknessMap:ue,gradientMap:te,opaque:x.transparent===!1&&x.blending===tr&&x.alphaToCoverage===!1,alphaMap:me,alphaTest:Q,alphaHash:j,combine:x.combine,mapUv:Ge&&_(x.map.channel),aoMapUv:Ae&&_(x.aoMap.channel),lightMapUv:we&&_(x.lightMap.channel),bumpMapUv:Me&&_(x.bumpMap.channel),normalMapUv:qe&&_(x.normalMap.channel),displacementMapUv:P&&_(x.displacementMap.channel),emissiveMapUv:nt&&_(x.emissiveMap.channel),metalnessMapUv:Xe&&_(x.metalnessMap.channel),roughnessMapUv:Ye&&_(x.roughnessMap.channel),anisotropyMapUv:W&&_(x.anisotropyMap.channel),clearcoatMapUv:ve&&_(x.clearcoatMap.channel),clearcoatNormalMapUv:ee&&_(x.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:_e&&_(x.clearcoatRoughnessMap.channel),iridescenceMapUv:Re&&_(x.iridescenceMap.channel),iridescenceThicknessMapUv:K&&_(x.iridescenceThicknessMap.channel),sheenColorMapUv:se&&_(x.sheenColorMap.channel),sheenRoughnessMapUv:ye&&_(x.sheenRoughnessMap.channel),specularMapUv:Se&&_(x.specularMap.channel),specularColorMapUv:re&&_(x.specularColorMap.channel),specularIntensityMapUv:He&&_(x.specularIntensityMap.channel),transmissionMapUv:D&&_(x.transmissionMap.channel),thicknessMapUv:ue&&_(x.thicknessMap.channel),alphaMapUv:me&&_(x.alphaMap.channel),vertexTangents:!!X.attributes.tangent&&(qe||de),vertexColors:x.vertexColors,vertexAlphas:x.vertexColors===!0&&!!X.attributes.color&&X.attributes.color.itemSize===4,pointsUvs:U.isPoints===!0&&!!X.attributes.uv&&(Ge||me),fog:!!O,useFog:x.fog===!0,fogExp2:!!O&&O.isFogExp2,flatShading:x.flatShading===!0&&x.wireframe===!1,sizeAttenuation:x.sizeAttenuation===!0,logarithmicDepthBuffer:d,reversedDepthBuffer:pe,skinning:U.isSkinnedMesh===!0,morphTargets:X.morphAttributes.position!==void 0,morphNormals:X.morphAttributes.normal!==void 0,morphColors:X.morphAttributes.color!==void 0,morphTargetsCount:ce,morphTextureStride:ke,numDirLights:M.directional.length,numPointLights:M.point.length,numSpotLights:M.spot.length,numSpotLightMaps:M.spotLightMap.length,numRectAreaLights:M.rectArea.length,numHemiLights:M.hemi.length,numDirLightShadows:M.directionalShadowMap.length,numPointLightShadows:M.pointShadowMap.length,numSpotLightShadows:M.spotShadowMap.length,numSpotLightShadowsWithMaps:M.numSpotLightShadowsWithMaps,numLightProbes:M.numLightProbes,numClippingPlanes:a.numPlanes,numClipIntersection:a.numIntersection,dithering:x.dithering,shadowMapEnabled:n.shadowMap.enabled&&I.length>0,shadowMapType:n.shadowMap.type,toneMapping:Oe,decodeVideoTexture:Ge&&x.map.isVideoTexture===!0&&Je.getTransfer(x.map.colorSpace)===rt,decodeVideoTextureEmissive:nt&&x.emissiveMap.isVideoTexture===!0&&Je.getTransfer(x.emissiveMap.colorSpace)===rt,premultipliedAlpha:x.premultipliedAlpha,doubleSided:x.side===kn,flipSided:x.side===Ht,useDepthPacking:x.depthPacking>=0,depthPacking:x.depthPacking||0,index0AttributeName:x.index0AttributeName,extensionClipCullDistance:ie&&x.extensions.clipCullDistance===!0&&i.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(ie&&x.extensions.multiDraw===!0||fe)&&i.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:i.has("KHR_parallel_shader_compile"),customProgramCacheKey:x.customProgramCacheKey()};return ct.vertexUv1s=c.has(1),ct.vertexUv2s=c.has(2),ct.vertexUv3s=c.has(3),c.clear(),ct}function f(x){let M=[];if(x.shaderID?M.push(x.shaderID):(M.push(x.customVertexShaderID),M.push(x.customFragmentShaderID)),x.defines!==void 0)for(let I in x.defines)M.push(I),M.push(x.defines[I]);return x.isRawShaderMaterial===!1&&(w(M,x),b(M,x),M.push(n.outputColorSpace)),M.push(x.customProgramCacheKey),M.join()}function w(x,M){x.push(M.precision),x.push(M.outputColorSpace),x.push(M.envMapMode),x.push(M.envMapCubeUVHeight),x.push(M.mapUv),x.push(M.alphaMapUv),x.push(M.lightMapUv),x.push(M.aoMapUv),x.push(M.bumpMapUv),x.push(M.normalMapUv),x.push(M.displacementMapUv),x.push(M.emissiveMapUv),x.push(M.metalnessMapUv),x.push(M.roughnessMapUv),x.push(M.anisotropyMapUv),x.push(M.clearcoatMapUv),x.push(M.clearcoatNormalMapUv),x.push(M.clearcoatRoughnessMapUv),x.push(M.iridescenceMapUv),x.push(M.iridescenceThicknessMapUv),x.push(M.sheenColorMapUv),x.push(M.sheenRoughnessMapUv),x.push(M.specularMapUv),x.push(M.specularColorMapUv),x.push(M.specularIntensityMapUv),x.push(M.transmissionMapUv),x.push(M.thicknessMapUv),x.push(M.combine),x.push(M.fogExp2),x.push(M.sizeAttenuation),x.push(M.morphTargetsCount),x.push(M.morphAttributeCount),x.push(M.numDirLights),x.push(M.numPointLights),x.push(M.numSpotLights),x.push(M.numSpotLightMaps),x.push(M.numHemiLights),x.push(M.numRectAreaLights),x.push(M.numDirLightShadows),x.push(M.numPointLightShadows),x.push(M.numSpotLightShadows),x.push(M.numSpotLightShadowsWithMaps),x.push(M.numLightProbes),x.push(M.shadowMapType),x.push(M.toneMapping),x.push(M.numClippingPlanes),x.push(M.numClipIntersection),x.push(M.depthPacking)}function b(x,M){o.disableAll(),M.instancing&&o.enable(0),M.instancingColor&&o.enable(1),M.instancingMorph&&o.enable(2),M.matcap&&o.enable(3),M.envMap&&o.enable(4),M.normalMapObjectSpace&&o.enable(5),M.normalMapTangentSpace&&o.enable(6),M.clearcoat&&o.enable(7),M.iridescence&&o.enable(8),M.alphaTest&&o.enable(9),M.vertexColors&&o.enable(10),M.vertexAlphas&&o.enable(11),M.vertexUv1s&&o.enable(12),M.vertexUv2s&&o.enable(13),M.vertexUv3s&&o.enable(14),M.vertexTangents&&o.enable(15),M.anisotropy&&o.enable(16),M.alphaHash&&o.enable(17),M.batching&&o.enable(18),M.dispersion&&o.enable(19),M.batchingColor&&o.enable(20),M.gradientMap&&o.enable(21),x.push(o.mask),o.disableAll(),M.fog&&o.enable(0),M.useFog&&o.enable(1),M.flatShading&&o.enable(2),M.logarithmicDepthBuffer&&o.enable(3),M.reversedDepthBuffer&&o.enable(4),M.skinning&&o.enable(5),M.morphTargets&&o.enable(6),M.morphNormals&&o.enable(7),M.morphColors&&o.enable(8),M.premultipliedAlpha&&o.enable(9),M.shadowMapEnabled&&o.enable(10),M.doubleSided&&o.enable(11),M.flipSided&&o.enable(12),M.useDepthPacking&&o.enable(13),M.dithering&&o.enable(14),M.transmission&&o.enable(15),M.sheen&&o.enable(16),M.opaque&&o.enable(17),M.pointsUvs&&o.enable(18),M.decodeVideoTexture&&o.enable(19),M.decodeVideoTextureEmissive&&o.enable(20),M.alphaToCoverage&&o.enable(21),x.push(o.mask)}function S(x){let M=g[x.type],I;if(M){let F=Wn[M];I=Sg.clone(F.uniforms)}else I=x.uniforms;return I}function E(x,M){let I=u.get(M);return I!==void 0?++I.usedTimes:(I=new mb(n,M,x,s),h.push(I),u.set(M,I)),I}function T(x){if(--x.usedTimes===0){let M=h.indexOf(x);h[M]=h[h.length-1],h.pop(),u.delete(x.cacheKey),x.destroy()}}function R(x){l.remove(x)}function C(){l.dispose()}return{getParameters:m,getProgramCacheKey:f,getUniforms:S,acquireProgram:E,releaseProgram:T,releaseShaderCache:R,programs:h,dispose:C}}function _b(){let n=new WeakMap;function e(a){return n.has(a)}function t(a){let o=n.get(a);return o===void 0&&(o={},n.set(a,o)),o}function i(a){n.delete(a)}function r(a,o,l){n.get(a)[o]=l}function s(){n=new WeakMap}return{has:e,get:t,remove:i,update:r,dispose:s}}function xb(n,e){return n.groupOrder!==e.groupOrder?n.groupOrder-e.groupOrder:n.renderOrder!==e.renderOrder?n.renderOrder-e.renderOrder:n.material.id!==e.material.id?n.material.id-e.material.id:n.z!==e.z?n.z-e.z:n.id-e.id}function Vg(n,e){return n.groupOrder!==e.groupOrder?n.groupOrder-e.groupOrder:n.renderOrder!==e.renderOrder?n.renderOrder-e.renderOrder:n.z!==e.z?e.z-n.z:n.id-e.id}function Hg(){let n=[],e=0,t=[],i=[],r=[];function s(){e=0,t.length=0,i.length=0,r.length=0}function a(u,d,p,g,_,m){let f=n[e];return f===void 0?(f={id:u.id,object:u,geometry:d,material:p,groupOrder:g,renderOrder:u.renderOrder,z:_,group:m},n[e]=f):(f.id=u.id,f.object=u,f.geometry=d,f.material=p,f.groupOrder=g,f.renderOrder=u.renderOrder,f.z=_,f.group=m),e++,f}function o(u,d,p,g,_,m){let f=a(u,d,p,g,_,m);p.transmission>0?i.push(f):p.transparent===!0?r.push(f):t.push(f)}function l(u,d,p,g,_,m){let f=a(u,d,p,g,_,m);p.transmission>0?i.unshift(f):p.transparent===!0?r.unshift(f):t.unshift(f)}function c(u,d){t.length>1&&t.sort(u||xb),i.length>1&&i.sort(d||Vg),r.length>1&&r.sort(d||Vg)}function h(){for(let u=e,d=n.length;u<d;u++){let p=n[u];if(p.id===null)break;p.id=null,p.object=null,p.geometry=null,p.material=null,p.group=null}}return{opaque:t,transmissive:i,transparent:r,init:s,push:o,unshift:l,finish:h,sort:c}}function yb(){let n=new WeakMap;function e(i,r){let s=n.get(i),a;return s===void 0?(a=new Hg,n.set(i,[a])):r>=s.length?(a=new Hg,s.push(a)):a=s[r],a}function t(){n=new WeakMap}return{get:e,dispose:t}}function Mb(){let n={};return{get:function(e){if(n[e.id]!==void 0)return n[e.id];let t;switch(e.type){case"DirectionalLight":t={direction:new z,color:new et};break;case"SpotLight":t={position:new z,direction:new z,color:new et,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":t={position:new z,color:new et,distance:0,decay:0};break;case"HemisphereLight":t={direction:new z,skyColor:new et,groundColor:new et};break;case"RectAreaLight":t={color:new et,position:new z,halfWidth:new z,halfHeight:new z};break}return n[e.id]=t,t}}}function Sb(){let n={};return{get:function(e){if(n[e.id]!==void 0)return n[e.id];let t;switch(e.type){case"DirectionalLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Ke};break;case"SpotLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Ke};break;case"PointLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Ke,shadowCameraNear:1,shadowCameraFar:1e3};break}return n[e.id]=t,t}}}var bb=0;function wb(n,e){return(e.castShadow?2:0)-(n.castShadow?2:0)+(e.map?1:0)-(n.map?1:0)}function Eb(n){let e=new Mb,t=Sb(),i={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let c=0;c<9;c++)i.probe.push(new z);let r=new z,s=new yt,a=new yt;function o(c){let h=0,u=0,d=0;for(let x=0;x<9;x++)i.probe[x].set(0,0,0);let p=0,g=0,_=0,m=0,f=0,w=0,b=0,S=0,E=0,T=0,R=0;c.sort(wb);for(let x=0,M=c.length;x<M;x++){let I=c[x],F=I.color,U=I.intensity,O=I.distance,X=null;if(I.shadow&&I.shadow.map&&(I.shadow.map.texture.format===cr?X=I.shadow.map.texture:X=I.shadow.map.depthTexture||I.shadow.map.texture),I.isAmbientLight)h+=F.r*U,u+=F.g*U,d+=F.b*U;else if(I.isLightProbe){for(let G=0;G<9;G++)i.probe[G].addScaledVector(I.sh.coefficients[G],U);R++}else if(I.isDirectionalLight){let G=e.get(I);if(G.color.copy(I.color).multiplyScalar(I.intensity),I.castShadow){let k=I.shadow,Z=t.get(I);Z.shadowIntensity=k.intensity,Z.shadowBias=k.bias,Z.shadowNormalBias=k.normalBias,Z.shadowRadius=k.radius,Z.shadowMapSize=k.mapSize,i.directionalShadow[p]=Z,i.directionalShadowMap[p]=X,i.directionalShadowMatrix[p]=I.shadow.matrix,w++}i.directional[p]=G,p++}else if(I.isSpotLight){let G=e.get(I);G.position.setFromMatrixPosition(I.matrixWorld),G.color.copy(F).multiplyScalar(U),G.distance=O,G.coneCos=Math.cos(I.angle),G.penumbraCos=Math.cos(I.angle*(1-I.penumbra)),G.decay=I.decay,i.spot[_]=G;let k=I.shadow;if(I.map&&(i.spotLightMap[E]=I.map,E++,k.updateMatrices(I),I.castShadow&&T++),i.spotLightMatrix[_]=k.matrix,I.castShadow){let Z=t.get(I);Z.shadowIntensity=k.intensity,Z.shadowBias=k.bias,Z.shadowNormalBias=k.normalBias,Z.shadowRadius=k.radius,Z.shadowMapSize=k.mapSize,i.spotShadow[_]=Z,i.spotShadowMap[_]=X,S++}_++}else if(I.isRectAreaLight){let G=e.get(I);G.color.copy(F).multiplyScalar(U),G.halfWidth.set(I.width*.5,0,0),G.halfHeight.set(0,I.height*.5,0),i.rectArea[m]=G,m++}else if(I.isPointLight){let G=e.get(I);if(G.color.copy(I.color).multiplyScalar(I.intensity),G.distance=I.distance,G.decay=I.decay,I.castShadow){let k=I.shadow,Z=t.get(I);Z.shadowIntensity=k.intensity,Z.shadowBias=k.bias,Z.shadowNormalBias=k.normalBias,Z.shadowRadius=k.radius,Z.shadowMapSize=k.mapSize,Z.shadowCameraNear=k.camera.near,Z.shadowCameraFar=k.camera.far,i.pointShadow[g]=Z,i.pointShadowMap[g]=X,i.pointShadowMatrix[g]=I.shadow.matrix,b++}i.point[g]=G,g++}else if(I.isHemisphereLight){let G=e.get(I);G.skyColor.copy(I.color).multiplyScalar(U),G.groundColor.copy(I.groundColor).multiplyScalar(U),i.hemi[f]=G,f++}}m>0&&(n.has("OES_texture_float_linear")===!0?(i.rectAreaLTC1=oe.LTC_FLOAT_1,i.rectAreaLTC2=oe.LTC_FLOAT_2):(i.rectAreaLTC1=oe.LTC_HALF_1,i.rectAreaLTC2=oe.LTC_HALF_2)),i.ambient[0]=h,i.ambient[1]=u,i.ambient[2]=d;let C=i.hash;(C.directionalLength!==p||C.pointLength!==g||C.spotLength!==_||C.rectAreaLength!==m||C.hemiLength!==f||C.numDirectionalShadows!==w||C.numPointShadows!==b||C.numSpotShadows!==S||C.numSpotMaps!==E||C.numLightProbes!==R)&&(i.directional.length=p,i.spot.length=_,i.rectArea.length=m,i.point.length=g,i.hemi.length=f,i.directionalShadow.length=w,i.directionalShadowMap.length=w,i.pointShadow.length=b,i.pointShadowMap.length=b,i.spotShadow.length=S,i.spotShadowMap.length=S,i.directionalShadowMatrix.length=w,i.pointShadowMatrix.length=b,i.spotLightMatrix.length=S+E-T,i.spotLightMap.length=E,i.numSpotLightShadowsWithMaps=T,i.numLightProbes=R,C.directionalLength=p,C.pointLength=g,C.spotLength=_,C.rectAreaLength=m,C.hemiLength=f,C.numDirectionalShadows=w,C.numPointShadows=b,C.numSpotShadows=S,C.numSpotMaps=E,C.numLightProbes=R,i.version=bb++)}function l(c,h){let u=0,d=0,p=0,g=0,_=0,m=h.matrixWorldInverse;for(let f=0,w=c.length;f<w;f++){let b=c[f];if(b.isDirectionalLight){let S=i.directional[u];S.direction.setFromMatrixPosition(b.matrixWorld),r.setFromMatrixPosition(b.target.matrixWorld),S.direction.sub(r),S.direction.transformDirection(m),u++}else if(b.isSpotLight){let S=i.spot[p];S.position.setFromMatrixPosition(b.matrixWorld),S.position.applyMatrix4(m),S.direction.setFromMatrixPosition(b.matrixWorld),r.setFromMatrixPosition(b.target.matrixWorld),S.direction.sub(r),S.direction.transformDirection(m),p++}else if(b.isRectAreaLight){let S=i.rectArea[g];S.position.setFromMatrixPosition(b.matrixWorld),S.position.applyMatrix4(m),a.identity(),s.copy(b.matrixWorld),s.premultiply(m),a.extractRotation(s),S.halfWidth.set(b.width*.5,0,0),S.halfHeight.set(0,b.height*.5,0),S.halfWidth.applyMatrix4(a),S.halfHeight.applyMatrix4(a),g++}else if(b.isPointLight){let S=i.point[d];S.position.setFromMatrixPosition(b.matrixWorld),S.position.applyMatrix4(m),d++}else if(b.isHemisphereLight){let S=i.hemi[_];S.direction.setFromMatrixPosition(b.matrixWorld),S.direction.transformDirection(m),_++}}}return{setup:o,setupView:l,state:i}}function Gg(n){let e=new Eb(n),t=[],i=[];function r(h){c.camera=h,t.length=0,i.length=0}function s(h){t.push(h)}function a(h){i.push(h)}function o(){e.setup(t)}function l(h){e.setupView(t,h)}let c={lightsArray:t,shadowsArray:i,camera:null,lights:e,transmissionRenderTarget:{}};return{init:r,state:c,setupLights:o,setupLightsView:l,pushLight:s,pushShadow:a}}function Ab(n){let e=new WeakMap;function t(r,s=0){let a=e.get(r),o;return a===void 0?(o=new Gg(n),e.set(r,[o])):s>=a.length?(o=new Gg(n),a.push(o)):o=a[s],o}function i(){e=new WeakMap}return{get:t,dispose:i}}var Tb=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`,Rb=[new z(1,0,0),new z(-1,0,0),new z(0,1,0),new z(0,-1,0),new z(0,0,1),new z(0,0,-1)],Ib=[new z(0,-1,0),new z(0,-1,0),new z(0,0,1),new z(0,0,-1),new z(0,-1,0),new z(0,-1,0)],Wg=new yt,pa=new z,Hu=new z;function Pb(n,e,t){let i=new ea,r=new Ke,s=new Ke,a=new _t,o=new nl,l=new il,c={},h=t.maxTextureSize,u={[si]:Ht,[Ht]:si,[kn]:kn},d=new Ft({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Ke},radius:{value:4}},vertexShader:Tb,fragmentShader:Cb}),p=d.clone();p.defines.HORIZONTAL_PASS=1;let g=new on;g.setAttribute("position",new It(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));let _=new $t(g,d),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=ra;let f=this.type;this.render=function(T,R,C){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||T.length===0)return;T.type===Wm&&(Ue("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),T.type=ra);let x=n.getRenderTarget(),M=n.getActiveCubeFace(),I=n.getActiveMipmapLevel(),F=n.state;F.setBlending(Vn),F.buffers.depth.getReversed()===!0?F.buffers.color.setClear(0,0,0,0):F.buffers.color.setClear(1,1,1,1),F.buffers.depth.setTest(!0),F.setScissorTest(!1);let U=f!==this.type;U&&R.traverse(function(O){O.material&&(Array.isArray(O.material)?O.material.forEach(X=>X.needsUpdate=!0):O.material.needsUpdate=!0)});for(let O=0,X=T.length;O<X;O++){let G=T[O],k=G.shadow;if(k===void 0){Ue("WebGLShadowMap:",G,"has no shadow.");continue}if(k.autoUpdate===!1&&k.needsUpdate===!1)continue;r.copy(k.mapSize);let Z=k.getFrameExtents();if(r.multiply(Z),s.copy(k.mapSize),(r.x>h||r.y>h)&&(r.x>h&&(s.x=Math.floor(h/Z.x),r.x=s.x*Z.x,k.mapSize.x=s.x),r.y>h&&(s.y=Math.floor(h/Z.y),r.y=s.y*Z.y,k.mapSize.y=s.y)),k.map===null||U===!0){if(k.map!==null&&(k.map.depthTexture!==null&&(k.map.depthTexture.dispose(),k.map.depthTexture=null),k.map.dispose()),this.type===Jr){if(G.isPointLight){Ue("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}k.map=new an(r.x,r.y,{format:cr,type:Hn,minFilter:Pt,magFilter:Pt,generateMipmaps:!1}),k.map.texture.name=G.name+".shadowMap",k.map.depthTexture=new Ti(r.x,r.y,Rn),k.map.depthTexture.name=G.name+".shadowMapDepth",k.map.depthTexture.format=zn,k.map.depthTexture.compareFunction=null,k.map.depthTexture.minFilter=Ct,k.map.depthTexture.magFilter=Ct}else{G.isPointLight?(k.map=new Qs(r.x),k.map.depthTexture=new el(r.x,Cn)):(k.map=new an(r.x,r.y),k.map.depthTexture=new Ti(r.x,r.y,Cn)),k.map.depthTexture.name=G.name+".shadowMap",k.map.depthTexture.format=zn;let ne=n.state.buffers.depth.getReversed();this.type===ra?(k.map.depthTexture.compareFunction=ne?cc:lc,k.map.depthTexture.minFilter=Pt,k.map.depthTexture.magFilter=Pt):(k.map.depthTexture.compareFunction=null,k.map.depthTexture.minFilter=Ct,k.map.depthTexture.magFilter=Ct)}k.camera.updateProjectionMatrix()}let le=k.map.isWebGLCubeRenderTarget?6:1;for(let ne=0;ne<le;ne++){if(k.map.isWebGLCubeRenderTarget)n.setRenderTarget(k.map,ne),n.clear();else{ne===0&&(n.setRenderTarget(k.map),n.clear());let ce=k.getViewport(ne);a.set(s.x*ce.x,s.y*ce.y,s.x*ce.z,s.y*ce.w),F.viewport(a)}if(G.isPointLight){let ce=k.camera,ke=k.matrix,De=G.distance||ce.far;De!==ce.far&&(ce.far=De,ce.updateProjectionMatrix()),pa.setFromMatrixPosition(G.matrixWorld),ce.position.copy(pa),Hu.copy(ce.position),Hu.add(Rb[ne]),ce.up.copy(Ib[ne]),ce.lookAt(Hu),ce.updateMatrixWorld(),ke.makeTranslation(-pa.x,-pa.y,-pa.z),Wg.multiplyMatrices(ce.projectionMatrix,ce.matrixWorldInverse),k._frustum.setFromProjectionMatrix(Wg,ce.coordinateSystem,ce.reversedDepth)}else k.updateMatrices(G);i=k.getFrustum(),S(R,C,k.camera,G,this.type)}k.isPointLightShadow!==!0&&this.type===Jr&&w(k,C),k.needsUpdate=!1}f=this.type,m.needsUpdate=!1,n.setRenderTarget(x,M,I)};function w(T,R){let C=e.update(_);d.defines.VSM_SAMPLES!==T.blurSamples&&(d.defines.VSM_SAMPLES=T.blurSamples,p.defines.VSM_SAMPLES=T.blurSamples,d.needsUpdate=!0,p.needsUpdate=!0),T.mapPass===null&&(T.mapPass=new an(r.x,r.y,{format:cr,type:Hn})),d.uniforms.shadow_pass.value=T.map.depthTexture,d.uniforms.resolution.value=T.mapSize,d.uniforms.radius.value=T.radius,n.setRenderTarget(T.mapPass),n.clear(),n.renderBufferDirect(R,null,C,d,_,null),p.uniforms.shadow_pass.value=T.mapPass.texture,p.uniforms.resolution.value=T.mapSize,p.uniforms.radius.value=T.radius,n.setRenderTarget(T.map),n.clear(),n.renderBufferDirect(R,null,C,p,_,null)}function b(T,R,C,x){let M=null,I=C.isPointLight===!0?T.customDistanceMaterial:T.customDepthMaterial;if(I!==void 0)M=I;else if(M=C.isPointLight===!0?l:o,n.localClippingEnabled&&R.clipShadows===!0&&Array.isArray(R.clippingPlanes)&&R.clippingPlanes.length!==0||R.displacementMap&&R.displacementScale!==0||R.alphaMap&&R.alphaTest>0||R.map&&R.alphaTest>0||R.alphaToCoverage===!0){let F=M.uuid,U=R.uuid,O=c[F];O===void 0&&(O={},c[F]=O);let X=O[U];X===void 0&&(X=M.clone(),O[U]=X,R.addEventListener("dispose",E)),M=X}if(M.visible=R.visible,M.wireframe=R.wireframe,x===Jr?M.side=R.shadowSide!==null?R.shadowSide:R.side:M.side=R.shadowSide!==null?R.shadowSide:u[R.side],M.alphaMap=R.alphaMap,M.alphaTest=R.alphaToCoverage===!0?.5:R.alphaTest,M.map=R.map,M.clipShadows=R.clipShadows,M.clippingPlanes=R.clippingPlanes,M.clipIntersection=R.clipIntersection,M.displacementMap=R.displacementMap,M.displacementScale=R.displacementScale,M.displacementBias=R.displacementBias,M.wireframeLinewidth=R.wireframeLinewidth,M.linewidth=R.linewidth,C.isPointLight===!0&&M.isMeshDistanceMaterial===!0){let F=n.properties.get(M);F.light=C}return M}function S(T,R,C,x,M){if(T.visible===!1)return;if(T.layers.test(R.layers)&&(T.isMesh||T.isLine||T.isPoints)&&(T.castShadow||T.receiveShadow&&M===Jr)&&(!T.frustumCulled||i.intersectsObject(T))){T.modelViewMatrix.multiplyMatrices(C.matrixWorldInverse,T.matrixWorld);let U=e.update(T),O=T.material;if(Array.isArray(O)){let X=U.groups;for(let G=0,k=X.length;G<k;G++){let Z=X[G],le=O[Z.materialIndex];if(le&&le.visible){let ne=b(T,le,x,M);T.onBeforeShadow(n,T,R,C,U,ne,Z),n.renderBufferDirect(C,null,U,ne,T,Z),T.onAfterShadow(n,T,R,C,U,ne,Z)}}}else if(O.visible){let X=b(T,O,x,M);T.onBeforeShadow(n,T,R,C,U,X,null),n.renderBufferDirect(C,null,U,X,T,null),T.onAfterShadow(n,T,R,C,U,X,null)}}let F=T.children;for(let U=0,O=F.length;U<O;U++)S(F[U],R,C,x,M)}function E(T){T.target.removeEventListener("dispose",E);for(let C in c){let x=c[C],M=T.target.uuid;M in x&&(x[M].dispose(),delete x[M])}}}var Db={[pl]:ml,[gl]:xl,[vl]:yl,[nr]:_l,[ml]:pl,[xl]:gl,[yl]:vl,[_l]:nr};function Lb(n,e){function t(){let D=!1,ue=new _t,te=null,me=new _t(0,0,0,0);return{setMask:function(Q){te!==Q&&!D&&(n.colorMask(Q,Q,Q,Q),te=Q)},setLocked:function(Q){D=Q},setClear:function(Q,j,ie,Oe,ct){ct===!0&&(Q*=Oe,j*=Oe,ie*=Oe),ue.set(Q,j,ie,Oe),me.equals(ue)===!1&&(n.clearColor(Q,j,ie,Oe),me.copy(ue))},reset:function(){D=!1,te=null,me.set(-1,0,0,0)}}}function i(){let D=!1,ue=!1,te=null,me=null,Q=null;return{setReversed:function(j){if(ue!==j){let ie=e.get("EXT_clip_control");j?ie.clipControlEXT(ie.LOWER_LEFT_EXT,ie.ZERO_TO_ONE_EXT):ie.clipControlEXT(ie.LOWER_LEFT_EXT,ie.NEGATIVE_ONE_TO_ONE_EXT),ue=j;let Oe=Q;Q=null,this.setClear(Oe)}},getReversed:function(){return ue},setTest:function(j){j?J(n.DEPTH_TEST):pe(n.DEPTH_TEST)},setMask:function(j){te!==j&&!D&&(n.depthMask(j),te=j)},setFunc:function(j){if(ue&&(j=Db[j]),me!==j){switch(j){case pl:n.depthFunc(n.NEVER);break;case ml:n.depthFunc(n.ALWAYS);break;case gl:n.depthFunc(n.LESS);break;case nr:n.depthFunc(n.LEQUAL);break;case vl:n.depthFunc(n.EQUAL);break;case _l:n.depthFunc(n.GEQUAL);break;case xl:n.depthFunc(n.GREATER);break;case yl:n.depthFunc(n.NOTEQUAL);break;default:n.depthFunc(n.LEQUAL)}me=j}},setLocked:function(j){D=j},setClear:function(j){Q!==j&&(ue&&(j=1-j),n.clearDepth(j),Q=j)},reset:function(){D=!1,te=null,me=null,Q=null,ue=!1}}}function r(){let D=!1,ue=null,te=null,me=null,Q=null,j=null,ie=null,Oe=null,ct=null;return{setTest:function(st){D||(st?J(n.STENCIL_TEST):pe(n.STENCIL_TEST))},setMask:function(st){ue!==st&&!D&&(n.stencilMask(st),ue=st)},setFunc:function(st,In,Xn){(te!==st||me!==In||Q!==Xn)&&(n.stencilFunc(st,In,Xn),te=st,me=In,Q=Xn)},setOp:function(st,In,Xn){(j!==st||ie!==In||Oe!==Xn)&&(n.stencilOp(st,In,Xn),j=st,ie=In,Oe=Xn)},setLocked:function(st){D=st},setClear:function(st){ct!==st&&(n.clearStencil(st),ct=st)},reset:function(){D=!1,ue=null,te=null,me=null,Q=null,j=null,ie=null,Oe=null,ct=null}}}let s=new t,a=new i,o=new r,l=new WeakMap,c=new WeakMap,h={},u={},d=new WeakMap,p=[],g=null,_=!1,m=null,f=null,w=null,b=null,S=null,E=null,T=null,R=new et(0,0,0),C=0,x=!1,M=null,I=null,F=null,U=null,O=null,X=n.getParameter(n.MAX_COMBINED_TEXTURE_IMAGE_UNITS),G=!1,k=0,Z=n.getParameter(n.VERSION);Z.indexOf("WebGL")!==-1?(k=parseFloat(/^WebGL (\d)/.exec(Z)[1]),G=k>=1):Z.indexOf("OpenGL ES")!==-1&&(k=parseFloat(/^OpenGL ES (\d)/.exec(Z)[1]),G=k>=2);let le=null,ne={},ce=n.getParameter(n.SCISSOR_BOX),ke=n.getParameter(n.VIEWPORT),De=new _t().fromArray(ce),tt=new _t().fromArray(ke);function Ze(D,ue,te,me){let Q=new Uint8Array(4),j=n.createTexture();n.bindTexture(D,j),n.texParameteri(D,n.TEXTURE_MIN_FILTER,n.NEAREST),n.texParameteri(D,n.TEXTURE_MAG_FILTER,n.NEAREST);for(let ie=0;ie<te;ie++)D===n.TEXTURE_3D||D===n.TEXTURE_2D_ARRAY?n.texImage3D(ue,0,n.RGBA,1,1,me,0,n.RGBA,n.UNSIGNED_BYTE,Q):n.texImage2D(ue+ie,0,n.RGBA,1,1,0,n.RGBA,n.UNSIGNED_BYTE,Q);return j}let Y={};Y[n.TEXTURE_2D]=Ze(n.TEXTURE_2D,n.TEXTURE_2D,1),Y[n.TEXTURE_CUBE_MAP]=Ze(n.TEXTURE_CUBE_MAP,n.TEXTURE_CUBE_MAP_POSITIVE_X,6),Y[n.TEXTURE_2D_ARRAY]=Ze(n.TEXTURE_2D_ARRAY,n.TEXTURE_2D_ARRAY,1,1),Y[n.TEXTURE_3D]=Ze(n.TEXTURE_3D,n.TEXTURE_3D,1,1),s.setClear(0,0,0,1),a.setClear(1),o.setClear(0),J(n.DEPTH_TEST),a.setFunc(nr),Me(!1),qe(uu),J(n.CULL_FACE),Ae(Vn);function J(D){h[D]!==!0&&(n.enable(D),h[D]=!0)}function pe(D){h[D]!==!1&&(n.disable(D),h[D]=!1)}function Le(D,ue){return u[D]!==ue?(n.bindFramebuffer(D,ue),u[D]=ue,D===n.DRAW_FRAMEBUFFER&&(u[n.FRAMEBUFFER]=ue),D===n.FRAMEBUFFER&&(u[n.DRAW_FRAMEBUFFER]=ue),!0):!1}function fe(D,ue){let te=p,me=!1;if(D){te=d.get(ue),te===void 0&&(te=[],d.set(ue,te));let Q=D.textures;if(te.length!==Q.length||te[0]!==n.COLOR_ATTACHMENT0){for(let j=0,ie=Q.length;j<ie;j++)te[j]=n.COLOR_ATTACHMENT0+j;te.length=Q.length,me=!0}}else te[0]!==n.BACK&&(te[0]=n.BACK,me=!0);me&&n.drawBuffers(te)}function Ge(D){return g!==D?(n.useProgram(D),g=D,!0):!1}let ut={[wi]:n.FUNC_ADD,[Xm]:n.FUNC_SUBTRACT,[qm]:n.FUNC_REVERSE_SUBTRACT};ut[Ym]=n.MIN,ut[$m]=n.MAX;let Ne={[jm]:n.ZERO,[fl]:n.ONE,[Zm]:n.SRC_COLOR,[Go]:n.SRC_ALPHA,[ng]:n.SRC_ALPHA_SATURATE,[eg]:n.DST_COLOR,[Km]:n.DST_ALPHA,[Jm]:n.ONE_MINUS_SRC_COLOR,[Wr]:n.ONE_MINUS_SRC_ALPHA,[tg]:n.ONE_MINUS_DST_COLOR,[Qm]:n.ONE_MINUS_DST_ALPHA,[ig]:n.CONSTANT_COLOR,[rg]:n.ONE_MINUS_CONSTANT_COLOR,[sg]:n.CONSTANT_ALPHA,[ag]:n.ONE_MINUS_CONSTANT_ALPHA};function Ae(D,ue,te,me,Q,j,ie,Oe,ct,st){if(D===Vn){_===!0&&(pe(n.BLEND),_=!1);return}if(_===!1&&(J(n.BLEND),_=!0),D!==dl){if(D!==m||st!==x){if((f!==wi||S!==wi)&&(n.blendEquation(n.FUNC_ADD),f=wi,S=wi),st)switch(D){case tr:n.blendFuncSeparate(n.ONE,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case du:n.blendFunc(n.ONE,n.ONE);break;case fu:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case pu:n.blendFuncSeparate(n.DST_COLOR,n.ONE_MINUS_SRC_ALPHA,n.ZERO,n.ONE);break;default:Pe("WebGLState: Invalid blending: ",D);break}else switch(D){case tr:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case du:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE,n.ONE,n.ONE);break;case fu:Pe("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case pu:Pe("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Pe("WebGLState: Invalid blending: ",D);break}w=null,b=null,E=null,T=null,R.set(0,0,0),C=0,m=D,x=st}return}Q=Q||ue,j=j||te,ie=ie||me,(ue!==f||Q!==S)&&(n.blendEquationSeparate(ut[ue],ut[Q]),f=ue,S=Q),(te!==w||me!==b||j!==E||ie!==T)&&(n.blendFuncSeparate(Ne[te],Ne[me],Ne[j],Ne[ie]),w=te,b=me,E=j,T=ie),(Oe.equals(R)===!1||ct!==C)&&(n.blendColor(Oe.r,Oe.g,Oe.b,ct),R.copy(Oe),C=ct),m=D,x=!1}function we(D,ue){D.side===kn?pe(n.CULL_FACE):J(n.CULL_FACE);let te=D.side===Ht;ue&&(te=!te),Me(te),D.blending===tr&&D.transparent===!1?Ae(Vn):Ae(D.blending,D.blendEquation,D.blendSrc,D.blendDst,D.blendEquationAlpha,D.blendSrcAlpha,D.blendDstAlpha,D.blendColor,D.blendAlpha,D.premultipliedAlpha),a.setFunc(D.depthFunc),a.setTest(D.depthTest),a.setMask(D.depthWrite),s.setMask(D.colorWrite);let me=D.stencilWrite;o.setTest(me),me&&(o.setMask(D.stencilWriteMask),o.setFunc(D.stencilFunc,D.stencilRef,D.stencilFuncMask),o.setOp(D.stencilFail,D.stencilZFail,D.stencilZPass)),nt(D.polygonOffset,D.polygonOffsetFactor,D.polygonOffsetUnits),D.alphaToCoverage===!0?J(n.SAMPLE_ALPHA_TO_COVERAGE):pe(n.SAMPLE_ALPHA_TO_COVERAGE)}function Me(D){M!==D&&(D?n.frontFace(n.CW):n.frontFace(n.CCW),M=D)}function qe(D){D!==Hm?(J(n.CULL_FACE),D!==I&&(D===uu?n.cullFace(n.BACK):D===Gm?n.cullFace(n.FRONT):n.cullFace(n.FRONT_AND_BACK))):pe(n.CULL_FACE),I=D}function P(D){D!==F&&(G&&n.lineWidth(D),F=D)}function nt(D,ue,te){D?(J(n.POLYGON_OFFSET_FILL),(U!==ue||O!==te)&&(n.polygonOffset(ue,te),U=ue,O=te)):pe(n.POLYGON_OFFSET_FILL)}function Xe(D){D?J(n.SCISSOR_TEST):pe(n.SCISSOR_TEST)}function Ye(D){D===void 0&&(D=n.TEXTURE0+X-1),le!==D&&(n.activeTexture(D),le=D)}function de(D,ue,te){te===void 0&&(le===null?te=n.TEXTURE0+X-1:te=le);let me=ne[te];me===void 0&&(me={type:void 0,texture:void 0},ne[te]=me),(me.type!==D||me.texture!==ue)&&(le!==te&&(n.activeTexture(te),le=te),n.bindTexture(D,ue||Y[D]),me.type=D,me.texture=ue)}function A(){let D=ne[le];D!==void 0&&D.type!==void 0&&(n.bindTexture(D.type,null),D.type=void 0,D.texture=void 0)}function v(){try{n.compressedTexImage2D(...arguments)}catch(D){Pe("WebGLState:",D)}}function L(){try{n.compressedTexImage3D(...arguments)}catch(D){Pe("WebGLState:",D)}}function q(){try{n.texSubImage2D(...arguments)}catch(D){Pe("WebGLState:",D)}}function $(){try{n.texSubImage3D(...arguments)}catch(D){Pe("WebGLState:",D)}}function W(){try{n.compressedTexSubImage2D(...arguments)}catch(D){Pe("WebGLState:",D)}}function ve(){try{n.compressedTexSubImage3D(...arguments)}catch(D){Pe("WebGLState:",D)}}function ee(){try{n.texStorage2D(...arguments)}catch(D){Pe("WebGLState:",D)}}function _e(){try{n.texStorage3D(...arguments)}catch(D){Pe("WebGLState:",D)}}function Re(){try{n.texImage2D(...arguments)}catch(D){Pe("WebGLState:",D)}}function K(){try{n.texImage3D(...arguments)}catch(D){Pe("WebGLState:",D)}}function se(D){De.equals(D)===!1&&(n.scissor(D.x,D.y,D.z,D.w),De.copy(D))}function ye(D){tt.equals(D)===!1&&(n.viewport(D.x,D.y,D.z,D.w),tt.copy(D))}function Se(D,ue){let te=c.get(ue);te===void 0&&(te=new WeakMap,c.set(ue,te));let me=te.get(D);me===void 0&&(me=n.getUniformBlockIndex(ue,D.name),te.set(D,me))}function re(D,ue){let me=c.get(ue).get(D);l.get(ue)!==me&&(n.uniformBlockBinding(ue,me,D.__bindingPointIndex),l.set(ue,me))}function He(){n.disable(n.BLEND),n.disable(n.CULL_FACE),n.disable(n.DEPTH_TEST),n.disable(n.POLYGON_OFFSET_FILL),n.disable(n.SCISSOR_TEST),n.disable(n.STENCIL_TEST),n.disable(n.SAMPLE_ALPHA_TO_COVERAGE),n.blendEquation(n.FUNC_ADD),n.blendFunc(n.ONE,n.ZERO),n.blendFuncSeparate(n.ONE,n.ZERO,n.ONE,n.ZERO),n.blendColor(0,0,0,0),n.colorMask(!0,!0,!0,!0),n.clearColor(0,0,0,0),n.depthMask(!0),n.depthFunc(n.LESS),a.setReversed(!1),n.clearDepth(1),n.stencilMask(4294967295),n.stencilFunc(n.ALWAYS,0,4294967295),n.stencilOp(n.KEEP,n.KEEP,n.KEEP),n.clearStencil(0),n.cullFace(n.BACK),n.frontFace(n.CCW),n.polygonOffset(0,0),n.activeTexture(n.TEXTURE0),n.bindFramebuffer(n.FRAMEBUFFER,null),n.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),n.bindFramebuffer(n.READ_FRAMEBUFFER,null),n.useProgram(null),n.lineWidth(1),n.scissor(0,0,n.canvas.width,n.canvas.height),n.viewport(0,0,n.canvas.width,n.canvas.height),h={},le=null,ne={},u={},d=new WeakMap,p=[],g=null,_=!1,m=null,f=null,w=null,b=null,S=null,E=null,T=null,R=new et(0,0,0),C=0,x=!1,M=null,I=null,F=null,U=null,O=null,De.set(0,0,n.canvas.width,n.canvas.height),tt.set(0,0,n.canvas.width,n.canvas.height),s.reset(),a.reset(),o.reset()}return{buffers:{color:s,depth:a,stencil:o},enable:J,disable:pe,bindFramebuffer:Le,drawBuffers:fe,useProgram:Ge,setBlending:Ae,setMaterial:we,setFlipSided:Me,setCullFace:qe,setLineWidth:P,setPolygonOffset:nt,setScissorTest:Xe,activeTexture:Ye,bindTexture:de,unbindTexture:A,compressedTexImage2D:v,compressedTexImage3D:L,texImage2D:Re,texImage3D:K,updateUBOMapping:Se,uniformBlockBinding:re,texStorage2D:ee,texStorage3D:_e,texSubImage2D:q,texSubImage3D:$,compressedTexSubImage2D:W,compressedTexSubImage3D:ve,scissor:se,viewport:ye,reset:He}}function Nb(n,e,t,i,r,s,a){let o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Ke,h=new WeakMap,u,d=new WeakMap,p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(A,v){return p?new OffscreenCanvas(A,v):Ws("canvas")}function _(A,v,L){let q=1,$=de(A);if(($.width>L||$.height>L)&&(q=L/Math.max($.width,$.height)),q<1)if(typeof HTMLImageElement<"u"&&A instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&A instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&A instanceof ImageBitmap||typeof VideoFrame<"u"&&A instanceof VideoFrame){let W=Math.floor(q*$.width),ve=Math.floor(q*$.height);u===void 0&&(u=g(W,ve));let ee=v?g(W,ve):u;return ee.width=W,ee.height=ve,ee.getContext("2d").drawImage(A,0,0,W,ve),Ue("WebGLRenderer: Texture has been resized from ("+$.width+"x"+$.height+") to ("+W+"x"+ve+")."),ee}else return"data"in A&&Ue("WebGLRenderer: Image in DataTexture is too big ("+$.width+"x"+$.height+")."),A;return A}function m(A){return A.generateMipmaps}function f(A){n.generateMipmap(A)}function w(A){return A.isWebGLCubeRenderTarget?n.TEXTURE_CUBE_MAP:A.isWebGL3DRenderTarget?n.TEXTURE_3D:A.isWebGLArrayRenderTarget||A.isCompressedArrayTexture?n.TEXTURE_2D_ARRAY:n.TEXTURE_2D}function b(A,v,L,q,$=!1){if(A!==null){if(n[A]!==void 0)return n[A];Ue("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+A+"'")}let W=v;if(v===n.RED&&(L===n.FLOAT&&(W=n.R32F),L===n.HALF_FLOAT&&(W=n.R16F),L===n.UNSIGNED_BYTE&&(W=n.R8)),v===n.RED_INTEGER&&(L===n.UNSIGNED_BYTE&&(W=n.R8UI),L===n.UNSIGNED_SHORT&&(W=n.R16UI),L===n.UNSIGNED_INT&&(W=n.R32UI),L===n.BYTE&&(W=n.R8I),L===n.SHORT&&(W=n.R16I),L===n.INT&&(W=n.R32I)),v===n.RG&&(L===n.FLOAT&&(W=n.RG32F),L===n.HALF_FLOAT&&(W=n.RG16F),L===n.UNSIGNED_BYTE&&(W=n.RG8)),v===n.RG_INTEGER&&(L===n.UNSIGNED_BYTE&&(W=n.RG8UI),L===n.UNSIGNED_SHORT&&(W=n.RG16UI),L===n.UNSIGNED_INT&&(W=n.RG32UI),L===n.BYTE&&(W=n.RG8I),L===n.SHORT&&(W=n.RG16I),L===n.INT&&(W=n.RG32I)),v===n.RGB_INTEGER&&(L===n.UNSIGNED_BYTE&&(W=n.RGB8UI),L===n.UNSIGNED_SHORT&&(W=n.RGB16UI),L===n.UNSIGNED_INT&&(W=n.RGB32UI),L===n.BYTE&&(W=n.RGB8I),L===n.SHORT&&(W=n.RGB16I),L===n.INT&&(W=n.RGB32I)),v===n.RGBA_INTEGER&&(L===n.UNSIGNED_BYTE&&(W=n.RGBA8UI),L===n.UNSIGNED_SHORT&&(W=n.RGBA16UI),L===n.UNSIGNED_INT&&(W=n.RGBA32UI),L===n.BYTE&&(W=n.RGBA8I),L===n.SHORT&&(W=n.RGBA16I),L===n.INT&&(W=n.RGBA32I)),v===n.RGB&&(L===n.UNSIGNED_INT_5_9_9_9_REV&&(W=n.RGB9_E5),L===n.UNSIGNED_INT_10F_11F_11F_REV&&(W=n.R11F_G11F_B10F)),v===n.RGBA){let ve=$?Hs:Je.getTransfer(q);L===n.FLOAT&&(W=n.RGBA32F),L===n.HALF_FLOAT&&(W=n.RGBA16F),L===n.UNSIGNED_BYTE&&(W=ve===rt?n.SRGB8_ALPHA8:n.RGBA8),L===n.UNSIGNED_SHORT_4_4_4_4&&(W=n.RGBA4),L===n.UNSIGNED_SHORT_5_5_5_1&&(W=n.RGB5_A1)}return(W===n.R16F||W===n.R32F||W===n.RG16F||W===n.RG32F||W===n.RGBA16F||W===n.RGBA32F)&&e.get("EXT_color_buffer_float"),W}function S(A,v){let L;return A?v===null||v===Cn||v===Qr?L=n.DEPTH24_STENCIL8:v===Rn?L=n.DEPTH32F_STENCIL8:v===Kr&&(L=n.DEPTH24_STENCIL8,Ue("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):v===null||v===Cn||v===Qr?L=n.DEPTH_COMPONENT24:v===Rn?L=n.DEPTH_COMPONENT32F:v===Kr&&(L=n.DEPTH_COMPONENT16),L}function E(A,v){return m(A)===!0||A.isFramebufferTexture&&A.minFilter!==Ct&&A.minFilter!==Pt?Math.log2(Math.max(v.width,v.height))+1:A.mipmaps!==void 0&&A.mipmaps.length>0?A.mipmaps.length:A.isCompressedTexture&&Array.isArray(A.image)?v.mipmaps.length:1}function T(A){let v=A.target;v.removeEventListener("dispose",T),C(v),v.isVideoTexture&&h.delete(v)}function R(A){let v=A.target;v.removeEventListener("dispose",R),M(v)}function C(A){let v=i.get(A);if(v.__webglInit===void 0)return;let L=A.source,q=d.get(L);if(q){let $=q[v.__cacheKey];$.usedTimes--,$.usedTimes===0&&x(A),Object.keys(q).length===0&&d.delete(L)}i.remove(A)}function x(A){let v=i.get(A);n.deleteTexture(v.__webglTexture);let L=A.source,q=d.get(L);delete q[v.__cacheKey],a.memory.textures--}function M(A){let v=i.get(A);if(A.depthTexture&&(A.depthTexture.dispose(),i.remove(A.depthTexture)),A.isWebGLCubeRenderTarget)for(let q=0;q<6;q++){if(Array.isArray(v.__webglFramebuffer[q]))for(let $=0;$<v.__webglFramebuffer[q].length;$++)n.deleteFramebuffer(v.__webglFramebuffer[q][$]);else n.deleteFramebuffer(v.__webglFramebuffer[q]);v.__webglDepthbuffer&&n.deleteRenderbuffer(v.__webglDepthbuffer[q])}else{if(Array.isArray(v.__webglFramebuffer))for(let q=0;q<v.__webglFramebuffer.length;q++)n.deleteFramebuffer(v.__webglFramebuffer[q]);else n.deleteFramebuffer(v.__webglFramebuffer);if(v.__webglDepthbuffer&&n.deleteRenderbuffer(v.__webglDepthbuffer),v.__webglMultisampledFramebuffer&&n.deleteFramebuffer(v.__webglMultisampledFramebuffer),v.__webglColorRenderbuffer)for(let q=0;q<v.__webglColorRenderbuffer.length;q++)v.__webglColorRenderbuffer[q]&&n.deleteRenderbuffer(v.__webglColorRenderbuffer[q]);v.__webglDepthRenderbuffer&&n.deleteRenderbuffer(v.__webglDepthRenderbuffer)}let L=A.textures;for(let q=0,$=L.length;q<$;q++){let W=i.get(L[q]);W.__webglTexture&&(n.deleteTexture(W.__webglTexture),a.memory.textures--),i.remove(L[q])}i.remove(A)}let I=0;function F(){I=0}function U(){let A=I;return A>=r.maxTextures&&Ue("WebGLTextures: Trying to use "+A+" texture units while this GPU supports only "+r.maxTextures),I+=1,A}function O(A){let v=[];return v.push(A.wrapS),v.push(A.wrapT),v.push(A.wrapR||0),v.push(A.magFilter),v.push(A.minFilter),v.push(A.anisotropy),v.push(A.internalFormat),v.push(A.format),v.push(A.type),v.push(A.generateMipmaps),v.push(A.premultiplyAlpha),v.push(A.flipY),v.push(A.unpackAlignment),v.push(A.colorSpace),v.join()}function X(A,v){let L=i.get(A);if(A.isVideoTexture&&Xe(A),A.isRenderTargetTexture===!1&&A.isExternalTexture!==!0&&A.version>0&&L.__version!==A.version){let q=A.image;if(q===null)Ue("WebGLRenderer: Texture marked for update but no image data found.");else if(q.complete===!1)Ue("WebGLRenderer: Texture marked for update but image is incomplete");else{Y(L,A,v);return}}else A.isExternalTexture&&(L.__webglTexture=A.sourceTexture?A.sourceTexture:null);t.bindTexture(n.TEXTURE_2D,L.__webglTexture,n.TEXTURE0+v)}function G(A,v){let L=i.get(A);if(A.isRenderTargetTexture===!1&&A.version>0&&L.__version!==A.version){Y(L,A,v);return}else A.isExternalTexture&&(L.__webglTexture=A.sourceTexture?A.sourceTexture:null);t.bindTexture(n.TEXTURE_2D_ARRAY,L.__webglTexture,n.TEXTURE0+v)}function k(A,v){let L=i.get(A);if(A.isRenderTargetTexture===!1&&A.version>0&&L.__version!==A.version){Y(L,A,v);return}t.bindTexture(n.TEXTURE_3D,L.__webglTexture,n.TEXTURE0+v)}function Z(A,v){let L=i.get(A);if(A.isCubeDepthTexture!==!0&&A.version>0&&L.__version!==A.version){J(L,A,v);return}t.bindTexture(n.TEXTURE_CUBE_MAP,L.__webglTexture,n.TEXTURE0+v)}let le={[Wo]:n.REPEAT,[Bn]:n.CLAMP_TO_EDGE,[Xo]:n.MIRRORED_REPEAT},ne={[Ct]:n.NEAREST,[cg]:n.NEAREST_MIPMAP_NEAREST,[aa]:n.NEAREST_MIPMAP_LINEAR,[Pt]:n.LINEAR,[bl]:n.LINEAR_MIPMAP_NEAREST,[Di]:n.LINEAR_MIPMAP_LINEAR},ce={[fg]:n.NEVER,[_g]:n.ALWAYS,[pg]:n.LESS,[lc]:n.LEQUAL,[mg]:n.EQUAL,[cc]:n.GEQUAL,[gg]:n.GREATER,[vg]:n.NOTEQUAL};function ke(A,v){if(v.type===Rn&&e.has("OES_texture_float_linear")===!1&&(v.magFilter===Pt||v.magFilter===bl||v.magFilter===aa||v.magFilter===Di||v.minFilter===Pt||v.minFilter===bl||v.minFilter===aa||v.minFilter===Di)&&Ue("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),n.texParameteri(A,n.TEXTURE_WRAP_S,le[v.wrapS]),n.texParameteri(A,n.TEXTURE_WRAP_T,le[v.wrapT]),(A===n.TEXTURE_3D||A===n.TEXTURE_2D_ARRAY)&&n.texParameteri(A,n.TEXTURE_WRAP_R,le[v.wrapR]),n.texParameteri(A,n.TEXTURE_MAG_FILTER,ne[v.magFilter]),n.texParameteri(A,n.TEXTURE_MIN_FILTER,ne[v.minFilter]),v.compareFunction&&(n.texParameteri(A,n.TEXTURE_COMPARE_MODE,n.COMPARE_REF_TO_TEXTURE),n.texParameteri(A,n.TEXTURE_COMPARE_FUNC,ce[v.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(v.magFilter===Ct||v.minFilter!==aa&&v.minFilter!==Di||v.type===Rn&&e.has("OES_texture_float_linear")===!1)return;if(v.anisotropy>1||i.get(v).__currentAnisotropy){let L=e.get("EXT_texture_filter_anisotropic");n.texParameterf(A,L.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(v.anisotropy,r.getMaxAnisotropy())),i.get(v).__currentAnisotropy=v.anisotropy}}}function De(A,v){let L=!1;A.__webglInit===void 0&&(A.__webglInit=!0,v.addEventListener("dispose",T));let q=v.source,$=d.get(q);$===void 0&&($={},d.set(q,$));let W=O(v);if(W!==A.__cacheKey){$[W]===void 0&&($[W]={texture:n.createTexture(),usedTimes:0},a.memory.textures++,L=!0),$[W].usedTimes++;let ve=$[A.__cacheKey];ve!==void 0&&($[A.__cacheKey].usedTimes--,ve.usedTimes===0&&x(v)),A.__cacheKey=W,A.__webglTexture=$[W].texture}return L}function tt(A,v,L){return Math.floor(Math.floor(A/L)/v)}function Ze(A,v,L,q){let W=A.updateRanges;if(W.length===0)t.texSubImage2D(n.TEXTURE_2D,0,0,0,v.width,v.height,L,q,v.data);else{W.sort((K,se)=>K.start-se.start);let ve=0;for(let K=1;K<W.length;K++){let se=W[ve],ye=W[K],Se=se.start+se.count,re=tt(ye.start,v.width,4),He=tt(se.start,v.width,4);ye.start<=Se+1&&re===He&&tt(ye.start+ye.count-1,v.width,4)===re?se.count=Math.max(se.count,ye.start+ye.count-se.start):(++ve,W[ve]=ye)}W.length=ve+1;let ee=n.getParameter(n.UNPACK_ROW_LENGTH),_e=n.getParameter(n.UNPACK_SKIP_PIXELS),Re=n.getParameter(n.UNPACK_SKIP_ROWS);n.pixelStorei(n.UNPACK_ROW_LENGTH,v.width);for(let K=0,se=W.length;K<se;K++){let ye=W[K],Se=Math.floor(ye.start/4),re=Math.ceil(ye.count/4),He=Se%v.width,D=Math.floor(Se/v.width),ue=re,te=1;n.pixelStorei(n.UNPACK_SKIP_PIXELS,He),n.pixelStorei(n.UNPACK_SKIP_ROWS,D),t.texSubImage2D(n.TEXTURE_2D,0,He,D,ue,te,L,q,v.data)}A.clearUpdateRanges(),n.pixelStorei(n.UNPACK_ROW_LENGTH,ee),n.pixelStorei(n.UNPACK_SKIP_PIXELS,_e),n.pixelStorei(n.UNPACK_SKIP_ROWS,Re)}}function Y(A,v,L){let q=n.TEXTURE_2D;(v.isDataArrayTexture||v.isCompressedArrayTexture)&&(q=n.TEXTURE_2D_ARRAY),v.isData3DTexture&&(q=n.TEXTURE_3D);let $=De(A,v),W=v.source;t.bindTexture(q,A.__webglTexture,n.TEXTURE0+L);let ve=i.get(W);if(W.version!==ve.__version||$===!0){t.activeTexture(n.TEXTURE0+L);let ee=Je.getPrimaries(Je.workingColorSpace),_e=v.colorSpace===li?null:Je.getPrimaries(v.colorSpace),Re=v.colorSpace===li||ee===_e?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,v.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,v.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,Re);let K=_(v.image,!1,r.maxTextureSize);K=Ye(v,K);let se=s.convert(v.format,v.colorSpace),ye=s.convert(v.type),Se=b(v.internalFormat,se,ye,v.colorSpace,v.isVideoTexture);ke(q,v);let re,He=v.mipmaps,D=v.isVideoTexture!==!0,ue=ve.__version===void 0||$===!0,te=W.dataReady,me=E(v,K);if(v.isDepthTexture)Se=S(v.format===Li,v.type),ue&&(D?t.texStorage2D(n.TEXTURE_2D,1,Se,K.width,K.height):t.texImage2D(n.TEXTURE_2D,0,Se,K.width,K.height,0,se,ye,null));else if(v.isDataTexture)if(He.length>0){D&&ue&&t.texStorage2D(n.TEXTURE_2D,me,Se,He[0].width,He[0].height);for(let Q=0,j=He.length;Q<j;Q++)re=He[Q],D?te&&t.texSubImage2D(n.TEXTURE_2D,Q,0,0,re.width,re.height,se,ye,re.data):t.texImage2D(n.TEXTURE_2D,Q,Se,re.width,re.height,0,se,ye,re.data);v.generateMipmaps=!1}else D?(ue&&t.texStorage2D(n.TEXTURE_2D,me,Se,K.width,K.height),te&&Ze(v,K,se,ye)):t.texImage2D(n.TEXTURE_2D,0,Se,K.width,K.height,0,se,ye,K.data);else if(v.isCompressedTexture)if(v.isCompressedArrayTexture){D&&ue&&t.texStorage3D(n.TEXTURE_2D_ARRAY,me,Se,He[0].width,He[0].height,K.depth);for(let Q=0,j=He.length;Q<j;Q++)if(re=He[Q],v.format!==_n)if(se!==null)if(D){if(te)if(v.layerUpdates.size>0){let ie=Uu(re.width,re.height,v.format,v.type);for(let Oe of v.layerUpdates){let ct=re.data.subarray(Oe*ie/re.data.BYTES_PER_ELEMENT,(Oe+1)*ie/re.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,Q,0,0,Oe,re.width,re.height,1,se,ct)}v.clearLayerUpdates()}else t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,Q,0,0,0,re.width,re.height,K.depth,se,re.data)}else t.compressedTexImage3D(n.TEXTURE_2D_ARRAY,Q,Se,re.width,re.height,K.depth,0,re.data,0,0);else Ue("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else D?te&&t.texSubImage3D(n.TEXTURE_2D_ARRAY,Q,0,0,0,re.width,re.height,K.depth,se,ye,re.data):t.texImage3D(n.TEXTURE_2D_ARRAY,Q,Se,re.width,re.height,K.depth,0,se,ye,re.data)}else{D&&ue&&t.texStorage2D(n.TEXTURE_2D,me,Se,He[0].width,He[0].height);for(let Q=0,j=He.length;Q<j;Q++)re=He[Q],v.format!==_n?se!==null?D?te&&t.compressedTexSubImage2D(n.TEXTURE_2D,Q,0,0,re.width,re.height,se,re.data):t.compressedTexImage2D(n.TEXTURE_2D,Q,Se,re.width,re.height,0,re.data):Ue("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):D?te&&t.texSubImage2D(n.TEXTURE_2D,Q,0,0,re.width,re.height,se,ye,re.data):t.texImage2D(n.TEXTURE_2D,Q,Se,re.width,re.height,0,se,ye,re.data)}else if(v.isDataArrayTexture)if(D){if(ue&&t.texStorage3D(n.TEXTURE_2D_ARRAY,me,Se,K.width,K.height,K.depth),te)if(v.layerUpdates.size>0){let Q=Uu(K.width,K.height,v.format,v.type);for(let j of v.layerUpdates){let ie=K.data.subarray(j*Q/K.data.BYTES_PER_ELEMENT,(j+1)*Q/K.data.BYTES_PER_ELEMENT);t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,j,K.width,K.height,1,se,ye,ie)}v.clearLayerUpdates()}else t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,0,K.width,K.height,K.depth,se,ye,K.data)}else t.texImage3D(n.TEXTURE_2D_ARRAY,0,Se,K.width,K.height,K.depth,0,se,ye,K.data);else if(v.isData3DTexture)D?(ue&&t.texStorage3D(n.TEXTURE_3D,me,Se,K.width,K.height,K.depth),te&&t.texSubImage3D(n.TEXTURE_3D,0,0,0,0,K.width,K.height,K.depth,se,ye,K.data)):t.texImage3D(n.TEXTURE_3D,0,Se,K.width,K.height,K.depth,0,se,ye,K.data);else if(v.isFramebufferTexture){if(ue)if(D)t.texStorage2D(n.TEXTURE_2D,me,Se,K.width,K.height);else{let Q=K.width,j=K.height;for(let ie=0;ie<me;ie++)t.texImage2D(n.TEXTURE_2D,ie,Se,Q,j,0,se,ye,null),Q>>=1,j>>=1}}else if(He.length>0){if(D&&ue){let Q=de(He[0]);t.texStorage2D(n.TEXTURE_2D,me,Se,Q.width,Q.height)}for(let Q=0,j=He.length;Q<j;Q++)re=He[Q],D?te&&t.texSubImage2D(n.TEXTURE_2D,Q,0,0,se,ye,re):t.texImage2D(n.TEXTURE_2D,Q,Se,se,ye,re);v.generateMipmaps=!1}else if(D){if(ue){let Q=de(K);t.texStorage2D(n.TEXTURE_2D,me,Se,Q.width,Q.height)}te&&t.texSubImage2D(n.TEXTURE_2D,0,0,0,se,ye,K)}else t.texImage2D(n.TEXTURE_2D,0,Se,se,ye,K);m(v)&&f(q),ve.__version=W.version,v.onUpdate&&v.onUpdate(v)}A.__version=v.version}function J(A,v,L){if(v.image.length!==6)return;let q=De(A,v),$=v.source;t.bindTexture(n.TEXTURE_CUBE_MAP,A.__webglTexture,n.TEXTURE0+L);let W=i.get($);if($.version!==W.__version||q===!0){t.activeTexture(n.TEXTURE0+L);let ve=Je.getPrimaries(Je.workingColorSpace),ee=v.colorSpace===li?null:Je.getPrimaries(v.colorSpace),_e=v.colorSpace===li||ve===ee?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,v.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,v.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,_e);let Re=v.isCompressedTexture||v.image[0].isCompressedTexture,K=v.image[0]&&v.image[0].isDataTexture,se=[];for(let j=0;j<6;j++)!Re&&!K?se[j]=_(v.image[j],!0,r.maxCubemapSize):se[j]=K?v.image[j].image:v.image[j],se[j]=Ye(v,se[j]);let ye=se[0],Se=s.convert(v.format,v.colorSpace),re=s.convert(v.type),He=b(v.internalFormat,Se,re,v.colorSpace),D=v.isVideoTexture!==!0,ue=W.__version===void 0||q===!0,te=$.dataReady,me=E(v,ye);ke(n.TEXTURE_CUBE_MAP,v);let Q;if(Re){D&&ue&&t.texStorage2D(n.TEXTURE_CUBE_MAP,me,He,ye.width,ye.height);for(let j=0;j<6;j++){Q=se[j].mipmaps;for(let ie=0;ie<Q.length;ie++){let Oe=Q[ie];v.format!==_n?Se!==null?D?te&&t.compressedTexSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+j,ie,0,0,Oe.width,Oe.height,Se,Oe.data):t.compressedTexImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+j,ie,He,Oe.width,Oe.height,0,Oe.data):Ue("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):D?te&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+j,ie,0,0,Oe.width,Oe.height,Se,re,Oe.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+j,ie,He,Oe.width,Oe.height,0,Se,re,Oe.data)}}}else{if(Q=v.mipmaps,D&&ue){Q.length>0&&me++;let j=de(se[0]);t.texStorage2D(n.TEXTURE_CUBE_MAP,me,He,j.width,j.height)}for(let j=0;j<6;j++)if(K){D?te&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,0,0,se[j].width,se[j].height,Se,re,se[j].data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,He,se[j].width,se[j].height,0,Se,re,se[j].data);for(let ie=0;ie<Q.length;ie++){let ct=Q[ie].image[j].image;D?te&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+j,ie+1,0,0,ct.width,ct.height,Se,re,ct.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+j,ie+1,He,ct.width,ct.height,0,Se,re,ct.data)}}else{D?te&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,0,0,Se,re,se[j]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,He,Se,re,se[j]);for(let ie=0;ie<Q.length;ie++){let Oe=Q[ie];D?te&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+j,ie+1,0,0,Se,re,Oe.image[j]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+j,ie+1,He,Se,re,Oe.image[j])}}}m(v)&&f(n.TEXTURE_CUBE_MAP),W.__version=$.version,v.onUpdate&&v.onUpdate(v)}A.__version=v.version}function pe(A,v,L,q,$,W){let ve=s.convert(L.format,L.colorSpace),ee=s.convert(L.type),_e=b(L.internalFormat,ve,ee,L.colorSpace),Re=i.get(v),K=i.get(L);if(K.__renderTarget=v,!Re.__hasExternalTextures){let se=Math.max(1,v.width>>W),ye=Math.max(1,v.height>>W);$===n.TEXTURE_3D||$===n.TEXTURE_2D_ARRAY?t.texImage3D($,W,_e,se,ye,v.depth,0,ve,ee,null):t.texImage2D($,W,_e,se,ye,0,ve,ee,null)}t.bindFramebuffer(n.FRAMEBUFFER,A),nt(v)?o.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,q,$,K.__webglTexture,0,P(v)):($===n.TEXTURE_2D||$>=n.TEXTURE_CUBE_MAP_POSITIVE_X&&$<=n.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&n.framebufferTexture2D(n.FRAMEBUFFER,q,$,K.__webglTexture,W),t.bindFramebuffer(n.FRAMEBUFFER,null)}function Le(A,v,L){if(n.bindRenderbuffer(n.RENDERBUFFER,A),v.depthBuffer){let q=v.depthTexture,$=q&&q.isDepthTexture?q.type:null,W=S(v.stencilBuffer,$),ve=v.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;nt(v)?o.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,P(v),W,v.width,v.height):L?n.renderbufferStorageMultisample(n.RENDERBUFFER,P(v),W,v.width,v.height):n.renderbufferStorage(n.RENDERBUFFER,W,v.width,v.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,ve,n.RENDERBUFFER,A)}else{let q=v.textures;for(let $=0;$<q.length;$++){let W=q[$],ve=s.convert(W.format,W.colorSpace),ee=s.convert(W.type),_e=b(W.internalFormat,ve,ee,W.colorSpace);nt(v)?o.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,P(v),_e,v.width,v.height):L?n.renderbufferStorageMultisample(n.RENDERBUFFER,P(v),_e,v.width,v.height):n.renderbufferStorage(n.RENDERBUFFER,_e,v.width,v.height)}}n.bindRenderbuffer(n.RENDERBUFFER,null)}function fe(A,v,L){let q=v.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(n.FRAMEBUFFER,A),!(v.depthTexture&&v.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");let $=i.get(v.depthTexture);if($.__renderTarget=v,(!$.__webglTexture||v.depthTexture.image.width!==v.width||v.depthTexture.image.height!==v.height)&&(v.depthTexture.image.width=v.width,v.depthTexture.image.height=v.height,v.depthTexture.needsUpdate=!0),q){if($.__webglInit===void 0&&($.__webglInit=!0,v.depthTexture.addEventListener("dispose",T)),$.__webglTexture===void 0){$.__webglTexture=n.createTexture(),t.bindTexture(n.TEXTURE_CUBE_MAP,$.__webglTexture),ke(n.TEXTURE_CUBE_MAP,v.depthTexture);let Re=s.convert(v.depthTexture.format),K=s.convert(v.depthTexture.type),se;v.depthTexture.format===zn?se=n.DEPTH_COMPONENT24:v.depthTexture.format===Li&&(se=n.DEPTH24_STENCIL8);for(let ye=0;ye<6;ye++)n.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ye,0,se,v.width,v.height,0,Re,K,null)}}else X(v.depthTexture,0);let W=$.__webglTexture,ve=P(v),ee=q?n.TEXTURE_CUBE_MAP_POSITIVE_X+L:n.TEXTURE_2D,_e=v.depthTexture.format===Li?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;if(v.depthTexture.format===zn)nt(v)?o.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,_e,ee,W,0,ve):n.framebufferTexture2D(n.FRAMEBUFFER,_e,ee,W,0);else if(v.depthTexture.format===Li)nt(v)?o.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,_e,ee,W,0,ve):n.framebufferTexture2D(n.FRAMEBUFFER,_e,ee,W,0);else throw new Error("Unknown depthTexture format")}function Ge(A){let v=i.get(A),L=A.isWebGLCubeRenderTarget===!0;if(v.__boundDepthTexture!==A.depthTexture){let q=A.depthTexture;if(v.__depthDisposeCallback&&v.__depthDisposeCallback(),q){let $=()=>{delete v.__boundDepthTexture,delete v.__depthDisposeCallback,q.removeEventListener("dispose",$)};q.addEventListener("dispose",$),v.__depthDisposeCallback=$}v.__boundDepthTexture=q}if(A.depthTexture&&!v.__autoAllocateDepthBuffer)if(L)for(let q=0;q<6;q++)fe(v.__webglFramebuffer[q],A,q);else{let q=A.texture.mipmaps;q&&q.length>0?fe(v.__webglFramebuffer[0],A,0):fe(v.__webglFramebuffer,A,0)}else if(L){v.__webglDepthbuffer=[];for(let q=0;q<6;q++)if(t.bindFramebuffer(n.FRAMEBUFFER,v.__webglFramebuffer[q]),v.__webglDepthbuffer[q]===void 0)v.__webglDepthbuffer[q]=n.createRenderbuffer(),Le(v.__webglDepthbuffer[q],A,!1);else{let $=A.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,W=v.__webglDepthbuffer[q];n.bindRenderbuffer(n.RENDERBUFFER,W),n.framebufferRenderbuffer(n.FRAMEBUFFER,$,n.RENDERBUFFER,W)}}else{let q=A.texture.mipmaps;if(q&&q.length>0?t.bindFramebuffer(n.FRAMEBUFFER,v.__webglFramebuffer[0]):t.bindFramebuffer(n.FRAMEBUFFER,v.__webglFramebuffer),v.__webglDepthbuffer===void 0)v.__webglDepthbuffer=n.createRenderbuffer(),Le(v.__webglDepthbuffer,A,!1);else{let $=A.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,W=v.__webglDepthbuffer;n.bindRenderbuffer(n.RENDERBUFFER,W),n.framebufferRenderbuffer(n.FRAMEBUFFER,$,n.RENDERBUFFER,W)}}t.bindFramebuffer(n.FRAMEBUFFER,null)}function ut(A,v,L){let q=i.get(A);v!==void 0&&pe(q.__webglFramebuffer,A,A.texture,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,0),L!==void 0&&Ge(A)}function Ne(A){let v=A.texture,L=i.get(A),q=i.get(v);A.addEventListener("dispose",R);let $=A.textures,W=A.isWebGLCubeRenderTarget===!0,ve=$.length>1;if(ve||(q.__webglTexture===void 0&&(q.__webglTexture=n.createTexture()),q.__version=v.version,a.memory.textures++),W){L.__webglFramebuffer=[];for(let ee=0;ee<6;ee++)if(v.mipmaps&&v.mipmaps.length>0){L.__webglFramebuffer[ee]=[];for(let _e=0;_e<v.mipmaps.length;_e++)L.__webglFramebuffer[ee][_e]=n.createFramebuffer()}else L.__webglFramebuffer[ee]=n.createFramebuffer()}else{if(v.mipmaps&&v.mipmaps.length>0){L.__webglFramebuffer=[];for(let ee=0;ee<v.mipmaps.length;ee++)L.__webglFramebuffer[ee]=n.createFramebuffer()}else L.__webglFramebuffer=n.createFramebuffer();if(ve)for(let ee=0,_e=$.length;ee<_e;ee++){let Re=i.get($[ee]);Re.__webglTexture===void 0&&(Re.__webglTexture=n.createTexture(),a.memory.textures++)}if(A.samples>0&&nt(A)===!1){L.__webglMultisampledFramebuffer=n.createFramebuffer(),L.__webglColorRenderbuffer=[],t.bindFramebuffer(n.FRAMEBUFFER,L.__webglMultisampledFramebuffer);for(let ee=0;ee<$.length;ee++){let _e=$[ee];L.__webglColorRenderbuffer[ee]=n.createRenderbuffer(),n.bindRenderbuffer(n.RENDERBUFFER,L.__webglColorRenderbuffer[ee]);let Re=s.convert(_e.format,_e.colorSpace),K=s.convert(_e.type),se=b(_e.internalFormat,Re,K,_e.colorSpace,A.isXRRenderTarget===!0),ye=P(A);n.renderbufferStorageMultisample(n.RENDERBUFFER,ye,se,A.width,A.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+ee,n.RENDERBUFFER,L.__webglColorRenderbuffer[ee])}n.bindRenderbuffer(n.RENDERBUFFER,null),A.depthBuffer&&(L.__webglDepthRenderbuffer=n.createRenderbuffer(),Le(L.__webglDepthRenderbuffer,A,!0)),t.bindFramebuffer(n.FRAMEBUFFER,null)}}if(W){t.bindTexture(n.TEXTURE_CUBE_MAP,q.__webglTexture),ke(n.TEXTURE_CUBE_MAP,v);for(let ee=0;ee<6;ee++)if(v.mipmaps&&v.mipmaps.length>0)for(let _e=0;_e<v.mipmaps.length;_e++)pe(L.__webglFramebuffer[ee][_e],A,v,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,_e);else pe(L.__webglFramebuffer[ee],A,v,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0);m(v)&&f(n.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(ve){for(let ee=0,_e=$.length;ee<_e;ee++){let Re=$[ee],K=i.get(Re),se=n.TEXTURE_2D;(A.isWebGL3DRenderTarget||A.isWebGLArrayRenderTarget)&&(se=A.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),t.bindTexture(se,K.__webglTexture),ke(se,Re),pe(L.__webglFramebuffer,A,Re,n.COLOR_ATTACHMENT0+ee,se,0),m(Re)&&f(se)}t.unbindTexture()}else{let ee=n.TEXTURE_2D;if((A.isWebGL3DRenderTarget||A.isWebGLArrayRenderTarget)&&(ee=A.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),t.bindTexture(ee,q.__webglTexture),ke(ee,v),v.mipmaps&&v.mipmaps.length>0)for(let _e=0;_e<v.mipmaps.length;_e++)pe(L.__webglFramebuffer[_e],A,v,n.COLOR_ATTACHMENT0,ee,_e);else pe(L.__webglFramebuffer,A,v,n.COLOR_ATTACHMENT0,ee,0);m(v)&&f(ee),t.unbindTexture()}A.depthBuffer&&Ge(A)}function Ae(A){let v=A.textures;for(let L=0,q=v.length;L<q;L++){let $=v[L];if(m($)){let W=w(A),ve=i.get($).__webglTexture;t.bindTexture(W,ve),f(W),t.unbindTexture()}}}let we=[],Me=[];function qe(A){if(A.samples>0){if(nt(A)===!1){let v=A.textures,L=A.width,q=A.height,$=n.COLOR_BUFFER_BIT,W=A.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,ve=i.get(A),ee=v.length>1;if(ee)for(let Re=0;Re<v.length;Re++)t.bindFramebuffer(n.FRAMEBUFFER,ve.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+Re,n.RENDERBUFFER,null),t.bindFramebuffer(n.FRAMEBUFFER,ve.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+Re,n.TEXTURE_2D,null,0);t.bindFramebuffer(n.READ_FRAMEBUFFER,ve.__webglMultisampledFramebuffer);let _e=A.texture.mipmaps;_e&&_e.length>0?t.bindFramebuffer(n.DRAW_FRAMEBUFFER,ve.__webglFramebuffer[0]):t.bindFramebuffer(n.DRAW_FRAMEBUFFER,ve.__webglFramebuffer);for(let Re=0;Re<v.length;Re++){if(A.resolveDepthBuffer&&(A.depthBuffer&&($|=n.DEPTH_BUFFER_BIT),A.stencilBuffer&&A.resolveStencilBuffer&&($|=n.STENCIL_BUFFER_BIT)),ee){n.framebufferRenderbuffer(n.READ_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.RENDERBUFFER,ve.__webglColorRenderbuffer[Re]);let K=i.get(v[Re]).__webglTexture;n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,K,0)}n.blitFramebuffer(0,0,L,q,0,0,L,q,$,n.NEAREST),l===!0&&(we.length=0,Me.length=0,we.push(n.COLOR_ATTACHMENT0+Re),A.depthBuffer&&A.resolveDepthBuffer===!1&&(we.push(W),Me.push(W),n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,Me)),n.invalidateFramebuffer(n.READ_FRAMEBUFFER,we))}if(t.bindFramebuffer(n.READ_FRAMEBUFFER,null),t.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),ee)for(let Re=0;Re<v.length;Re++){t.bindFramebuffer(n.FRAMEBUFFER,ve.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+Re,n.RENDERBUFFER,ve.__webglColorRenderbuffer[Re]);let K=i.get(v[Re]).__webglTexture;t.bindFramebuffer(n.FRAMEBUFFER,ve.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+Re,n.TEXTURE_2D,K,0)}t.bindFramebuffer(n.DRAW_FRAMEBUFFER,ve.__webglMultisampledFramebuffer)}else if(A.depthBuffer&&A.resolveDepthBuffer===!1&&l){let v=A.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,[v])}}}function P(A){return Math.min(r.maxSamples,A.samples)}function nt(A){let v=i.get(A);return A.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&v.__useRenderToTexture!==!1}function Xe(A){let v=a.render.frame;h.get(A)!==v&&(h.set(A,v),A.update())}function Ye(A,v){let L=A.colorSpace,q=A.format,$=A.type;return A.isCompressedTexture===!0||A.isVideoTexture===!0||L!==ir&&L!==li&&(Je.getTransfer(L)===rt?(q!==_n||$!==cn)&&Ue("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Pe("WebGLTextures: Unsupported texture color space:",L)),v}function de(A){return typeof HTMLImageElement<"u"&&A instanceof HTMLImageElement?(c.width=A.naturalWidth||A.width,c.height=A.naturalHeight||A.height):typeof VideoFrame<"u"&&A instanceof VideoFrame?(c.width=A.displayWidth,c.height=A.displayHeight):(c.width=A.width,c.height=A.height),c}this.allocateTextureUnit=U,this.resetTextureUnits=F,this.setTexture2D=X,this.setTexture2DArray=G,this.setTexture3D=k,this.setTextureCube=Z,this.rebindTextures=ut,this.setupRenderTarget=Ne,this.updateRenderTargetMipmap=Ae,this.updateMultisampleRenderTarget=qe,this.setupDepthRenderbuffer=Ge,this.setupFrameBufferTexture=pe,this.useMultisampledRTT=nt,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function Fb(n,e){function t(i,r=li){let s,a=Je.getTransfer(r);if(i===cn)return n.UNSIGNED_BYTE;if(i===El)return n.UNSIGNED_SHORT_4_4_4_4;if(i===Al)return n.UNSIGNED_SHORT_5_5_5_1;if(i===Eu)return n.UNSIGNED_INT_5_9_9_9_REV;if(i===Au)return n.UNSIGNED_INT_10F_11F_11F_REV;if(i===bu)return n.BYTE;if(i===wu)return n.SHORT;if(i===Kr)return n.UNSIGNED_SHORT;if(i===wl)return n.INT;if(i===Cn)return n.UNSIGNED_INT;if(i===Rn)return n.FLOAT;if(i===Hn)return n.HALF_FLOAT;if(i===Tu)return n.ALPHA;if(i===Cu)return n.RGB;if(i===_n)return n.RGBA;if(i===zn)return n.DEPTH_COMPONENT;if(i===Li)return n.DEPTH_STENCIL;if(i===Ru)return n.RED;if(i===Tl)return n.RED_INTEGER;if(i===cr)return n.RG;if(i===Cl)return n.RG_INTEGER;if(i===Rl)return n.RGBA_INTEGER;if(i===oa||i===la||i===ca||i===ha)if(a===rt)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(i===oa)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===la)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===ca)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===ha)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(i===oa)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===la)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===ca)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===ha)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===Il||i===Pl||i===Dl||i===Ll)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(i===Il)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===Pl)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===Dl)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===Ll)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===Nl||i===Fl||i===Ul||i===Ol||i===Bl||i===zl||i===kl)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(i===Nl||i===Fl)return a===rt?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(i===Ul)return a===rt?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC;if(i===Ol)return s.COMPRESSED_R11_EAC;if(i===Bl)return s.COMPRESSED_SIGNED_R11_EAC;if(i===zl)return s.COMPRESSED_RG11_EAC;if(i===kl)return s.COMPRESSED_SIGNED_RG11_EAC}else return null;if(i===Vl||i===Hl||i===Gl||i===Wl||i===Xl||i===ql||i===Yl||i===$l||i===jl||i===Zl||i===Jl||i===Kl||i===Ql||i===ec)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(i===Vl)return a===rt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===Hl)return a===rt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===Gl)return a===rt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===Wl)return a===rt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===Xl)return a===rt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===ql)return a===rt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===Yl)return a===rt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===$l)return a===rt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===jl)return a===rt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===Zl)return a===rt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===Jl)return a===rt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===Kl)return a===rt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===Ql)return a===rt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===ec)return a===rt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===tc||i===nc||i===ic)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(i===tc)return a===rt?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===nc)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===ic)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===rc||i===sc||i===ac||i===oc)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(i===rc)return s.COMPRESSED_RED_RGTC1_EXT;if(i===sc)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===ac)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===oc)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===Qr?n.UNSIGNED_INT_24_8:n[i]!==void 0?n[i]:null}return{convert:t}}var Ub=`
void main() {
...
}`,Zu=class{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){let i=new na(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=i}}getMesh(e){if(this.texture!==null&&this.mesh===null){let t=e.cameras[0].viewport,i=new Ft({vertexShader:Ub,fragmentShader:Ob,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new $t(new ar(20,20),i)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}},Ju=class extends ai{constructor(e,t){super();let i=this,r=null,s=1,a=null,o="local-floor",l=1,c=null,h=null,u=null,d=null,p=null,g=null,_=typeof XRWebGLBinding<"u",m=new Zu,f={},w=t.getContextAttributes(),b=null,S=null,E=[],T=[],R=new Ke,C=null,x=new Yt;x.viewport=new _t;let M=new Yt;M.viewport=new _t;let I=[x,M],F=new ul,U=null,O=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(Y){let J=E[Y];return J===void 0&&(J=new jr,E[Y]=J),J.getTargetRaySpace()},this.getControllerGrip=function(Y){let J=E[Y];return J===void 0&&(J=new jr,E[Y]=J),J.getGripSpace()},this.getHand=function(Y){let J=E[Y];return J===void 0&&(J=new jr,E[Y]=J),J.getHandSpace()};function X(Y){let J=T.indexOf(Y.inputSource);if(J===-1)return;let pe=E[J];pe!==void 0&&(pe.update(Y.inputSource,Y.frame,c||a),pe.dispatchEvent({type:Y.type,data:Y.inputSource}))}function G(){r.removeEventListener("select",X),r.removeEventListener("selectstart",X),r.removeEventListener("selectend",X),r.removeEventListener("squeeze",X),r.removeEventListener("squeezestart",X),r.removeEventListener("squeezeend",X),r.removeEventListener("end",G),r.removeEventListener("inputsourceschange",k);for(let Y=0;Y<E.length;Y++){let J=T[Y];J!==null&&(T[Y]=null,E[Y].disconnect(J))}U=null,O=null,m.reset();for(let Y in f)delete f[Y];e.setRenderTarget(b),p=null,d=null,u=null,r=null,S=null,Ze.stop(),i.isPresenting=!1,e.setPixelRatio(C),e.setSize(R.width,R.height,!1),i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(Y){s=Y,i.isPresenting===!0&&Ue("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(Y){o=Y,i.isPresenting===!0&&Ue("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(Y){c=Y},this.getBaseLayer=function(){return d!==null?d:p},this.getBinding=function(){return u===null&&_&&(u=new XRWebGLBinding(r,t)),u},this.getFrame=function(){return g},this.getSession=function(){return r},this.setSession=async function(Y){if(r=Y,r!==null){if(b=e.getRenderTarget(),r.addEventListener("select",X),r.addEventListener("selectstart",X),r.addEventListener("selectend",X),r.addEventListener("squeeze",X),r.addEventListener("squeezestart",X),r.addEventListener("squeezeend",X),r.addEventListener("end",G),r.addEventListener("inputsourceschange",k),w.xrCompatible!==!0&&await t.makeXRCompatible(),C=e.getPixelRatio(),e.getSize(R),_&&"createProjectionLayer"in XRWebGLBinding.prototype){let pe=null,Le=null,fe=null;w.depth&&(fe=w.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,pe=w.stencil?Li:zn,Le=w.stencil?Qr:Cn);let Ge={colorFormat:t.RGBA8,depthFormat:fe,scaleFactor:s};u=this.getBinding(),d=u.createProjectionLayer(Ge),r.updateRenderState({layers:[d]}),e.setPixelRatio(1),e.setSize(d.textureWidth,d.textureHeight,!1),S=new an(d.textureWidth,d.textureHeight,{format:_n,type:cn,depthTexture:new Ti(d.textureWidth,d.textureHeight,Le,void 0,void 0,void 0,void 0,void 0,void 0,pe),stencilBuffer:w.stencil,colorSpace:e.outputColorSpace,samples:w.antialias?4:0,resolveDepthBuffer:d.ignoreDepthValues===!1,resolveStencilBuffer:d.ignoreDepthValues===!1})}else{let pe={antialias:w.antialias,alpha:!0,depth:w.depth,stencil:w.stencil,framebufferScaleFactor:s};p=new XRWebGLLayer(r,t,pe),r.updateRenderState({baseLayer:p}),e.setPixelRatio(1),e.setSize(p.framebufferWidth,p.framebufferHeight,!1),S=new an(p.framebufferWidth,p.framebufferHeight,{format:_n,type:cn,colorSpace:e.outputColorSpace,stencilBuffer:w.stencil,resolveDepthBuffer:p.ignoreDepthValues===!1,resolveStencilBuffer:p.ignoreDepthValues===!1})}S.isXRRenderTarget=!0,this.setFoveation(l),c=null,a=await r.requestReferenceSpace(o),Ze.setContext(r),Ze.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return m.getDepthTexture()};function k(Y){for(let J=0;J<Y.removed.length;J++){let pe=Y.removed[J],Le=T.indexOf(pe);Le>=0&&(T[Le]=null,E[Le].disconnect(pe))}for(let J=0;J<Y.added.length;J++){let pe=Y.added[J],Le=T.indexOf(pe);if(Le===-1){for(let Ge=0;Ge<E.length;Ge++)if(Ge>=T.length){T.push(pe),Le=Ge;break}else if(T[Ge]===null){T[Ge]=pe,Le=Ge;break}if(Le===-1)break}let fe=E[Le];fe&&fe.connect(pe)}}let Z=new z,le=new z;function ne(Y,J,pe){Z.setFromMatrixPosition(J.matrixWorld),le.setFromMatrixPosition(pe.matrixWorld);let Le=Z.distanceTo(le),fe=J.projectionMatrix.elements,Ge=pe.projectionMatrix.elements,ut=fe[14]/(fe[10]-1),Ne=fe[14]/(fe[10]+1),Ae=(fe[9]+1)/fe[5],we=(fe[9]-1)/fe[5],Me=(fe[8]-1)/fe[0],qe=(Ge[8]+1)/Ge[0],P=ut*Me,nt=ut*qe,Xe=Le/(-Me+qe),Ye=Xe*-Me;if(J.matrixWorld.decompose(Y.position,Y.quaternion,Y.scale),Y.translateX(Ye),Y.translateZ(Xe),Y.matrixWorld.compose(Y.position,Y.quaternion,Y.scale),Y.matrixWorldInverse.copy(Y.matrixWorld).invert(),fe[10]===-1)Y.projectionMatrix.copy(J.projectionMatrix),Y.projectionMatrixInverse.copy(J.projectionMatrixInverse);else{let de=ut+Xe,A=Ne+Xe,v=P-Ye,L=nt+(Le-Ye),q=Ae*Ne/A*de,$=we*Ne/A*de;Y.projectionMatrix.makePerspective(v,L,q,$,de,A),Y.projectionMatrixInverse.copy(Y.projectionMatrix).invert()}}function ce(Y,J){J===null?Y.matrixWorld.copy(Y.matrix):Y.matrixWorld.multiplyMatrices(J.matrixWorld,Y.matrix),Y.matrixWorldInverse.copy(Y.matrixWorld).invert()}this.updateCamera=function(Y){if(r===null)return;let J=Y.near,pe=Y.far;m.texture!==null&&(m.depthNear>0&&(J=m.depthNear),m.depthFar>0&&(pe=m.depthFar)),F.near=M.near=x.near=J,F.far=M.far=x.far=pe,(U!==F.near||O!==F.far)&&(r.updateRenderState({depthNear:F.near,depthFar:F.far}),U=F.near,O=F.far),F.layers.mask=Y.layers.mask|6,x.layers.mask=F.layers.mask&3,M.layers.mask=F.layers.mask&5;let Le=Y.parent,fe=F.cameras;ce(F,Le);for(let Ge=0;Ge<fe.length;Ge++)ce(fe[Ge],Le);fe.length===2?ne(F,x,M):F.projectionMatrix.copy(x.projectionMatrix),ke(Y,F,Le)};function ke(Y,J,pe){pe===null?Y.matrix.copy(J.matrixWorld):(Y.matrix.copy(pe.matrixWorld),Y.matrix.invert(),Y.matrix.multiply(J.matrixWorld)),Y.matrix.decompose(Y.position,Y.quaternion,Y.scale),Y.updateMatrixWorld(!0),Y.projectionMatrix.copy(J.projectionMatrix),Y.projectionMatrixInverse.copy(J.projectionMatrixInverse),Y.isPerspectiveCamera&&(Y.fov=Yo*2*Math.atan(1/Y.projectionMatrix.elements[5]),Y.zoom=1)}this.getCamera=function(){return F},this.getFoveation=function(){if(!(d===null&&p===null))return l},this.setFoveation=function(Y){l=Y,d!==null&&(d.fixedFoveation=Y),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=Y)},this.hasDepthSensing=function(){return m.texture!==null},this.getDepthSensingMesh=function(){return m.getMesh(F)},this.getCameraTexture=function(Y){return f[Y]};let De=null;function tt(Y,J){if(h=J.getViewerPose(c||a),g=J,h!==null){let pe=h.views;p!==null&&(e.setRenderTargetFramebuffer(S,p.framebuffer),e.setRenderTarget(S));let Le=!1;pe.length!==F.cameras.length&&(F.cameras.length=0,Le=!0);for(let Ne=0;Ne<pe.length;Ne++){let Ae=pe[Ne],we=null;if(p!==null)we=p.getViewport(Ae);else{let qe=u.getViewSubImage(d,Ae);we=qe.viewport,Ne===0&&(e.setRenderTargetTextures(S,qe.colorTexture,qe.depthStencilTexture),e.setRenderTarget(S))}let Me=I[Ne];Me===void 0&&(Me=new Yt,Me.layers.enable(Ne),Me.viewport=new _t,I[Ne]=Me),Me.matrix.fromArray(Ae.transform.matrix),Me.matrix.decompose(Me.position,Me.quaternion,Me.scale),Me.projectionMatrix.fromArray(Ae.projectionMatrix),Me.projectionMatrixInverse.copy(Me.projectionMatrix).invert(),Me.viewport.set(we.x,we.y,we.width,we.height),Ne===0&&(F.matrix.copy(Me.matrix),F.matrix.decompose(F.position,F.quaternion,F.scale)),Le===!0&&F.cameras.push(Me)}let fe=r.enabledFeatures;if(fe&&fe.includes("depth-sensing")&&r.depthUsage=="gpu-optimized"&&_){u=i.getBinding();let Ne=u.getDepthInformation(pe[0]);Ne&&Ne.isValid&&Ne.texture&&m.init(Ne,r.renderState)}if(fe&&fe.includes("camera-access")&&_){e.state.unbindTexture(),u=i.getBinding();for(let Ne=0;Ne<pe.length;Ne++){let Ae=pe[Ne].camera;if(Ae){let we=f[Ae];we||(we=new na,f[Ae]=we);let Me=u.getCameraImage(Ae);we.sourceTexture=Me}}}}for(let pe=0;pe<E.length;pe++){let Le=T[pe],fe=E[pe];Le!==null&&fe!==void 0&&fe.update(Le,J,c||a)}De&&De(Y,J),J.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:J}),g=null}let Ze=new Xg;Ze.setAnimationLoop(tt),this.setAnimationLoop=function(Y){De=Y},this.dispose=function(){}}},dr=new sr,Bb=new yt;function zb(n,e){function t(m,f){m.matrixAutoUpdate===!0&&m.updateMatrix(),f.value.copy(m.matrix)}function i(m,f){f.color.getRGB(m.fogColor.value,Lu(n)),f.isFog?(m.fogNear.value=f.near,m.fogFar.value=f.far):f.isFogExp2&&(m.fogDensity.value=f.density)}function r(m,f,w,b,S){f.isMeshBasicMaterial||f.isMeshLambertMaterial?s(m,f):f.isMeshToonMaterial?(s(m,f),u(m,f)):f.isMeshPhongMaterial?(s(m,f),h(m,f)):f.isMeshStandardMaterial?(s(m,f),d(m,f),f.isMeshPhysicalMaterial&&p(m,f,S)):f.isMeshMatcapMaterial?(s(m,f),g(m,f)):f.isMeshDepthMaterial?s(m,f):f.isMeshDistanceMaterial?(s(m,f),_(m,f)):f.isMeshNormalMaterial?s(m,f):f.isLineBasicMaterial?(a(m,f),f.isLineDashedMaterial&&o(m,f)):f.isPointsMaterial?l(m,f,w,b):f.isSpriteMaterial?c(m,f):f.isShadowMaterial?(m.color.value.copy(f.color),m.opacity.value=f.opacity):f.isShaderMaterial&&(f.uniformsNeedUpdate=!1)}function s(m,f){m.opacity.value=f.opacity,f.color&&m.diffuse.value.copy(f.color),f.emissive&&m.emissive.value.copy(f.emissive).multiplyScalar(f.emissiveIntensity),f.map&&(m.map.value=f.map,t(f.map,m.mapTransform)),f.alphaMap&&(m.alphaMap.value=f.alphaMap,t(f.alphaMap,m.alphaMapTransform)),f.bumpMap&&(m.bumpMap.value=f.bumpMap,t(f.bumpMap,m.bumpMapTransform),m.bumpScale.value=f.bumpScale,f.side===Ht&&(m.bumpScale.value*=-1)),f.normalMap&&(m.normalMap.value=f.normalMap,t(f.normalMap,m.normalMapTransform),m.normalScale.value.copy(f.normalScale),f.side===Ht&&m.normalScale.value.negate()),f.displacementMap&&(m.displacementMap.value=f.displacementMap,t(f.displacementMap,m.displacementMapTransform),m.displacementScale.value=f.displacementScale,m.displacementBias.value=f.displacementBias),f.emissiveMap&&(m.emissiveMap.value=f.emissiveMap,t(f.emissiveMap,m.emissiveMapTransform)),f.specularMap&&(m.specularMap.value=f.specularMap,t(f.specularMap,m.specularMapTransform)),f.alphaTest>0&&(m.alphaTest.value=f.alphaTest);let w=e.get(f),b=w.envMap,S=w.envMapRotation;b&&(m.envMap.value=b,dr.copy(S),dr.x*=-1,dr.y*=-1,dr.z*=-1,b.isCubeTexture&&b.isRenderTargetTexture===!1&&(dr.y*=-1,dr.z*=-1),m.envMapRotation.value.setFromMatrix4(Bb.makeRotationFromEuler(dr)),m.flipEnvMap.value=b.isCubeTexture&&b.isRenderTargetTexture===!1?-1:1,m.reflectivity.value=f.reflectivity,m.ior.value=f.ior,m.refractionRatio.value=f.refractionRatio),f.lightMap&&(m.lightMap.value=f.lightMap,m.lightMapIntensity.value=f.lightMapIntensity,t(f.lightMap,m.lightMapTransform)),f.aoMap&&(m.aoMap.value=f.aoMap,m.aoMapIntensity.value=f.aoMapIntensity,t(f.aoMap,m.aoMapTransform))}function a(m,f){m.diffuse.value.copy(f.color),m.opacity.value=f.opacity,f.map&&(m.map.value=f.map,t(f.map,m.mapTransform))}function o(m,f){m.dashSize.value=f.dashSize,m.totalSize.value=f.dashSize+f.gapSize,m.scale.value=f.scale}function l(m,f,w,b){m.diffuse.value.copy(f.color),m.opacity.value=f.opacity,m.size.value=f.size*w,m.scale.value=b*.5,f.map&&(m.map.value=f.map,t(f.map,m.uvTransform)),f.alphaMap&&(m.alphaMap.value=f.alphaMap,t(f.alphaMap,m.alphaMapTransform)),f.alphaTest>0&&(m.alphaTest.value=f.alphaTest)}function c(m,f){m.diffuse.value.copy(f.color),m.opacity.value=f.opacity,m.rotation.value=f.rotation,f.map&&(m.map.value=f.map,t(f.map,m.mapTransform)),f.alphaMap&&(m.alphaMap.value=f.alphaMap,t(f.alphaMap,m.alphaMapTransform)),f.alphaTest>0&&(m.alphaTest.value=f.alphaTest)}function h(m,f){m.specular.value.copy(f.specular),m.shininess.value=Math.max(f.shininess,1e-4)}function u(m,f){f.gradientMap&&(m.gradientMap.value=f.gradientMap)}function d(m,f){m.metalness.value=f.metalness,f.metalnessMap&&(m.metalnessMap.value=f.metalnessMap,t(f.metalnessMap,m.metalnessMapTransform)),m.roughness.value=f.roughness,f.roughnessMap&&(m.roughnessMap.value=f.roughnessMap,t(f.roughnessMap,m.roughnessMapTransform)),f.envMap&&(m.envMapIntensity.value=f.envMapIntensity)}function p(m,f,w){m.ior.value=f.ior,f.sheen>0&&(m.sheenColor.value.copy(f.sheenColor).multiplyScalar(f.sheen),m.sheenRoughness.value=f.sheenRoughness,f.sheenColorMap&&(m.sheenColorMap.value=f.sheenColorMap,t(f.sheenColorMap,m.sheenColorMapTransform)),f.sheenRoughnessMap&&(m.sheenRoughnessMap.value=f.sheenRoughnessMap,t(f.sheenRoughnessMap,m.sheenRoughnessMapTransform))),f.clearcoat>0&&(m.clearcoat.value=f.clearcoat,m.clearcoatRoughness.value=f.clearcoatRoughness,f.clearcoatMap&&(m.clearcoatMap.value=f.clearcoatMap,t(f.clearcoatMap,m.clearcoatMapTransform)),f.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=f.clearcoatRoughnessMap,t(f.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),f.clearcoatNormalMap&&(m.clearcoatNormalMap.value=f.clearcoatNormalMap,t(f.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(f.clearcoatNormalScale),f.side===Ht&&m.clearcoatNormalScale.value.negate())),f.dispersion>0&&(m.dispersion.value=f.dispersion),f.iridescence>0&&(m.iridescence.value=f.iridescence,m.iridescenceIOR.value=f.iridescenceIOR,m.iridescenceThicknessMinimum.value=f.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=f.iridescenceThicknessRange[1],f.iridescenceMap&&(m.iridescenceMap.value=f.iridescenceMap,t(f.iridescenceMap,m.iridescenceMapTransform)),f.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=f.iridescenceThicknessMap,t(f.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),f.transmission>0&&(m.transmission.value=f.transmission,m.transmissionSamplerMap.value=w.texture,m.transmissionSamplerSize.value.set(w.width,w.height),f.transmissionMap&&(m.transmissionMap.value=f.transmissionMap,t(f.transmissionMap,m.transmissionMapTransform)),m.thickness.value=f.thickness,f.thicknessMap&&(m.thicknessMap.value=f.thicknessMap,t(f.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=f.attenuationDistance,m.attenuationColor.value.copy(f.attenuationColor)),f.anisotropy>0&&(m.anisotropyVector.value.set(f.anisotropy*Math.cos(f.anisotropyRotation),f.anisotropy*Math.sin(f.anisotropyRotation)),f.anisotropyMap&&(m.anisotropyMap.value=f.anisotropyMap,t(f.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=f.specularIntensity,m.specularColor.value.copy(f.specularColor),f.specularColorMap&&(m.specularColorMap.value=f.specularColorMap,t(f.specularColorMap,m.specularColorMapTransform)),f.specularIntensityMap&&(m.specularIntensityMap.value=f.specularIntensityMap,t(f.specularIntensityMap,m.specularIntensityMapTransform))}function g(m,f){f.matcap&&(m.matcap.value=f.matcap)}function _(m,f){let w=e.get(f).light;m.referencePosition.value.setFromMatrixPosition(w.matrixWorld),m.nearDistance.value=w.shadow.camera.near,m.farDistance.value=w.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:r}}function kb(n,e,t,i){let r={},s={},a=[],o=n.getParameter(n.MAX_UNIFORM_BUFFER_BINDINGS);function l(w,b){let S=b.program;i.uniformBlockBinding(w,S)}function c(w,b){let S=r[w.id];S===void 0&&(g(w),S=h(w),r[w.id]=S,w.addEventListener("dispose",m));let E=b.program;i.updateUBOMapping(w,E);let T=e.render.frame;s[w.id]!==T&&(d(w),s[w.id]=T)}function h(w){let b=u();w.__bindingPointIndex=b;let S=n.createBuffer(),E=w.__size,T=w.usage;return n.bindBuffer(n.UNIFORM_BUFFER,S),n.bufferData(n.UNIFORM_BUFFER,E,T),n.bindBuffer(n.UNIFORM_BUFFER,null),n.bindBufferBase(n.UNIFORM_BUFFER,b,S),S}function u(){for(let w=0;w<o;w++)if(a.indexOf(w)===-1)return a.push(w),w;return Pe("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function d(w){let b=r[w.id],S=w.uniforms,E=w.__cache;n.bindBuffer(n.UNIFORM_BUFFER,b);for(let T=0,R=S.length;T<R;T++){let C=Array.isArray(S[T])?S[T]:[S[T]];for(let x=0,M=C.length;x<M;x++){let I=C[x];if(p(I,T,x,E)===!0){let F=I.__offset,U=Array.isArray(I.value)?I.value:[I.value],O=0;for(let X=0;X<U.length;X++){let G=U[X],k=_(G);typeof G=="number"||typeof G=="boolean"?(I.__data[0]=G,n.bufferSubData(n.UNIFORM_BUFFER,F+O,I.__data)):G.isMatrix3?(I.__data[0]=G.elements[0],I.__data[1]=G.elements[1],I.__data[2]=G.elements[2],I.__data[3]=0,I.__data[4]=G.elements[3],I.__data[5]=G.elements[4],I.__data[6]=G.elements[5],I.__data[7]=0,I.__data[8]=G.elements[6],I.__data[9]=G.elements[7],I.__data[10]=G.elements[8],I.__data[11]=0):(G.toArray(I.__data,O),O+=k.storage/Float32Array.BYTES_PER_ELEMENT)}n.bufferSubData(n.UNIFORM_BUFFER,F,I.__data)}}}n.bindBuffer(n.UNIFORM_BUFFER,null)}function p(w,b,S,E){let T=w.value,R=b+"_"+S;if(E[R]===void 0)return typeof T=="number"||typeof T=="boolean"?E[R]=T:E[R]=T.clone(),!0;{let C=E[R];if(typeof T=="number"||typeof T=="boolean"){if(C!==T)return E[R]=T,!0}else if(C.equals(T)===!1)return C.copy(T),!0}return!1}function g(w){let b=w.uniforms,S=0,E=16;for(let R=0,C=b.length;R<C;R++){let x=Array.isArray(b[R])?b[R]:[b[R]];for(let M=0,I=x.length;M<I;M++){let F=x[M],U=Array.isArray(F.value)?F.value:[F.value];for(let O=0,X=U.length;O<X;O++){let G=U[O],k=_(G),Z=S%E,le=Z%k.boundary,ne=Z+le;S+=le,ne!==0&&E-ne<k.storage&&(S+=E-ne),F.__data=new Float32Array(k.storage/Float32Array.BYTES_PER_ELEMENT),F.__offset=S,S+=k.storage}}}let T=S%E;return T>0&&(S+=E-T),w.__size=S,w.__cache={},this}function _(w){let b={boundary:0,storage:0};return typeof w=="number"||typeof w=="boolean"?(b.boundary=4,b.storage=4):w.isVector2?(b.boundary=8,b.storage=8):w.isVector3||w.isColor?(b.boundary=16,b.storage=12):w.isVector4?(b.boundary=16,b.storage=16):w.isMatrix3?(b.boundary=48,b.storage=48):w.isMatrix4?(b.boundary=64,b.storage=64):w.isTexture?Ue("WebGLRenderer: Texture samplers can not be part of an uniforms group."):Ue("WebGLRenderer: Unsupported uniform value type.",w),b}function m(w){let b=w.target;b.removeEventListener("dispose",m);let S=a.indexOf(b.__bindingPointIndex);a.splice(S,1),n.deleteBuffer(r[b.id]),delete r[b.id],delete s[b.id]}function f(){for(let w in r)n.deleteBuffer(r[w]);a=[],r={},s={}}return{bind:l,update:c,dispose:f}}var Vb=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]),Gn=null;function Hb(){return Gn===null&&(Gn=new Ko(Vb,16,16,cr,Hn),Gn.name="DFG_LUT",Gn.minFilter=Pt,Gn.magFilter=Pt,Gn.wrapS=Bn,Gn.wrapT=Bn,Gn.generateMipmaps=!1,Gn.needsUpdate=!0),Gn}var ga=class{constructor(e={}){let{canvas:t=xg(),context:i=null,depth:r=!0,stencil:s=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:h="default",failIfMajorPerformanceCaveat:u=!1,reversedDepthBuffer:d=!1,outputBufferType:p=cn}=e;this.isWebGLRenderer=!0;let g;if(i!==null){if(typeof WebGLRenderingContext<"u"&&i instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");g=i.getContextAttributes().alpha}else g=a;let _=p,m=new Set([Rl,Cl,Tl]),f=new Set([cn,Cn,Kr,Qr,El,Al]),w=new Uint32Array(4),b=new Int32Array(4),S=null,E=null,T=[],R=[],C=null;this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=Tn,this.toneMappingExposure=1,this.transmissionResolutionScale=1;let x=this,M=!1;this._outputColorSpace=sn;let I=0,F=0,U=null,O=-1,X=null,G=new _t,k=new _t,Z=null,le=new et(0),ne=0,ce=t.width,ke=t.height,De=1,tt=null,Ze=null,Y=new _t(0,0,ce,ke),J=new _t(0,0,ce,ke),pe=!1,Le=new ea,fe=!1,Ge=!1,ut=new yt,Ne=new z,Ae=new _t,we={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},Me=!1;function qe(){return U===null?De:1}let P=i;function nt(y,N){return t.getContext(y,N)}try{let y={alpha:!0,depth:r,stencil:s,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:h,failIfMajorPerformanceCaveat:u};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${"182"}`),t.addEventListener("webglcontextlost",Oe,!1),t.addEventListener("webglcontextrestored",ct,!1),t.addEventListener("webglcontextcreationerror",st,!1),P===null){let N="webgl2";if(P=nt(N,y),P===null)throw nt(N)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(y){throw Pe("WebGLRenderer: "+y.message),y}let Xe,Ye,de,A,v,L,q,$,W,ve,ee,_e,Re,K,se,ye,Se,re,He,D,ue,te,me,Q;function j(){Xe=new jM(P),Xe.init(),te=new Fb(P,Xe),Ye=new kM(P,Xe,e,te),de=new Lb(P,Xe),Ye.reversedDepthBuffer&&d&&de.buffers.depth.setReversed(!0),A=new KM(P),v=new _b,L=new Nb(P,Xe,de,v,Ye,te,A),q=new HM(x),$=new $M(x),W=new nx(P),me=new BM(P,W),ve=new ZM(P,W,A,me),ee=new eS(P,ve,W,A),He=new QM(P,Ye,L),ye=new VM(v),_e=new vb(x,q,$,Xe,Ye,me,ye),Re=new zb(x,v),K=new yb,se=new Ab(Xe),re=new OM(x,q,$,de,ee,g,l),Se=new Pb(x,ee,Ye),Q=new kb(P,A,Ye,de),D=new zM(P,Xe,A),ue=new JM(P,Xe,A),A.programs=_e.programs,x.capabilities=Ye,x.extensions=Xe,x.properties=v,x.renderLists=K,x.shadowMap=Se,x.state=de,x.info=A}j(),_!==cn&&(C=new nS(_,t.width,t.height,r,s));let ie=new Ju(x,P);this.xr=ie,this.getContext=function(){return P},this.getContextAttributes=function(){return P.getContextAttributes()},this.forceContextLoss=function(){let y=Xe.get("WEBGL_lose_context");y&&y.loseContext()},this.forceContextRestore=function(){let y=Xe.get("WEBGL_lose_context");y&&y.restoreContext()},this.getPixelRatio=function(){return De},this.setPixelRatio=function(y){y!==void 0&&(De=y,this.setSize(ce,ke,!1))},this.getSize=function(y){return y.set(ce,ke)},this.setSize=function(y,N,H=!0){if(ie.isPresenting){Ue("WebGLRenderer: Can't change size while VR device is presenting.");return}ce=y,ke=N,t.width=Math.floor(y*De),t.height=Math.floor(N*De),H===!0&&(t.style.width=y+"px",t.style.height=N+"px"),C!==null&&C.setSize(t.width,t.height),this.setViewport(0,0,y,N)},this.getDrawingBufferSize=function(y){return y.set(ce*De,ke*De).floor()},this.setDrawingBufferSize=function(y,N,H){ce=y,ke=N,De=H,t.width=Math.floor(y*H),t.height=Math.floor(N*H),this.setViewport(0,0,y,N)},this.setEffects=function(y){if(_===cn){console.error("THREE.WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(y){for(let N=0;N<y.length;N++)if(y[N].isOutputPass===!0){console.warn("THREE.WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}C.setEffects(y||[])},this.getCurrentViewport=function(y){return y.copy(G)},this.getViewport=function(y){return y.copy(Y)},this.setViewport=function(y,N,H,V){y.isVector4?Y.set(y.x,y.y,y.z,y.w):Y.set(y,N,H,V),de.viewport(G.copy(Y).multiplyScalar(De).round())},this.getScissor=function(y){return y.copy(J)},this.setScissor=function(y,N,H,V){y.isVector4?J.set(y.x,y.y,y.z,y.w):J.set(y,N,H,V),de.scissor(k.copy(J).multiplyScalar(De).round())},this.getScissorTest=function(){return pe},this.setScissorTest=function(y){de.setScissorTest(pe=y)},this.setOpaqueSort=function(y){tt=y},this.setTransparentSort=function(y){Ze=y},this.getClearColor=function(y){return y.copy(re.getClearColor())},this.setClearColor=function(){re.setClearColor(...arguments)},this.getClearAlpha=function(){return re.getClearAlpha()},this.setClearAlpha=function(){re.setClearAlpha(...arguments)},this.clear=function(y=!0,N=!0,H=!0){let V=0;if(y){let B=!1;if(U!==null){let ae=U.texture.format;B=m.has(ae)}if(B){let ae=U.texture.type,ge=f.has(ae),he=re.getClearColor(),xe=re.getClearAlpha(),be=he.r,Ie=he.g,Te=he.b;ge?(w[0]=be,w[1]=Ie,w[2]=Te,w[3]=xe,P.clearBufferuiv(P.COLOR,0,w)):(b[0]=be,b[1]=Ie,b[2]=Te,b[3]=xe,P.clearBufferiv(P.COLOR,0,b))}else V|=P.COLOR_BUFFER_BIT}N&&(V|=P.DEPTH_BUFFER_BIT),H&&(V|=P.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),P.clear(V)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){t.removeEventListener("webglcontextlost",Oe,!1),t.removeEventListener("webglcontextrestored",ct,!1),t.removeEventListener("webglcontextcreationerror",st,!1),re.dispose(),K.dispose(),se.dispose(),v.dispose(),q.dispose(),$.dispose(),ee.dispose(),me.dispose(),Q.dispose(),_e.dispose(),ie.dispose(),ie.removeEventListener("sessionstart",ed),ie.removeEventListener("sessionend",td),Ui.stop()};function Oe(y){y.preventDefault(),Du("WebGLRenderer: Context Lost."),M=!0}function ct(){Du("WebGLRenderer: Context Restored."),M=!1;let y=A.autoReset,N=Se.enabled,H=Se.autoUpdate,V=Se.needsUpdate,B=Se.type;j(),A.autoReset=y,Se.enabled=N,Se.autoUpdate=H,Se.needsUpdate=V,Se.type=B}function st(y){Pe("WebGLRenderer: A WebGL context could not be created. Reason: ",y.statusMessage)}function In(y){let N=y.target;N.removeEventListener("dispose",In),Xn(N)}function Xn(y){Zg(y),v.remove(y)}function Zg(y){let N=v.get(y).programs;N!==void 0&&(N.forEach(function(H){_e.releaseProgram(H)}),y.isShaderMaterial&&_e.releaseShaderCache(y))}this.renderBufferDirect=function(y,N,H,V,B,ae){N===null&&(N=we);let ge=B.isMesh&&B.matrixWorld.determinant()<0,he=Kg(y,N,H,V,B);de.setMaterial(V,ge);let xe=H.index,be=1;if(V.wireframe===!0){if(xe=ve.getWireframeAttribute(H),xe===void 0)return;be=2}let Ie=H.drawRange,Te=H.attributes.position,We=Ie.start*be,ot=(Ie.start+Ie.count)*be;ae!==null&&(We=Math.max(We,ae.start*be),ot=Math.min(ot,(ae.start+ae.count)*be)),xe!==null?(We=Math.max(We,0),ot=Math.min(ot,xe.count)):Te!=null&&(We=Math.max(We,0),ot=Math.min(ot,Te.count));let mt=ot-We;if(mt<0||mt===1/0)return;me.setup(B,V,he,H,xe);let gt,lt=D;if(xe!==null&&(gt=W.get(xe),lt=ue,lt.setIndex(gt)),B.isMesh)V.wireframe===!0?(de.setLineWidth(V.wireframeLinewidth*qe()),lt.setMode(P.LINES)):lt.setMode(P.TRIANGLES);else if(B.isLine){let Ce=V.linewidth;Ce===void 0&&(Ce=1),de.setLineWidth(Ce*qe()),B.isLineSegments?lt.setMode(P.LINES):B.isLineLoop?lt.setMode(P.LINE_LOOP):lt.setMode(P.LINE_STRIP)}else B.isPoints?lt.setMode(P.POINTS):B.isSprite&&lt.setMode(P.TRIANGLES);if(B.isBatchedMesh)if(B._multiDrawInstances!==null)qr("WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),lt.renderMultiDrawInstances(B._multiDrawStarts,B._multiDrawCounts,B._multiDrawCount,B._multiDrawInstances);else if(Xe.get("WEBGL_multi_draw"))lt.renderMultiDraw(B._multiDrawStarts,B._multiDrawCounts,B._multiDrawCount);else{let Ce=B._multiDrawStarts,at=B._multiDrawCounts,Qe=B._multiDrawCount,jt=xe?W.get(xe).bytesPerElement:1,mr=v.get(V).currentProgram.getUniforms();for(let Zt=0;Zt<Qe;Zt++)mr.setValue(P,"_gl_DrawID",Zt),lt.render(Ce[Zt]/jt,at[Zt])}else if(B.isInstancedMesh)lt.renderInstances(We,mt,B.count);else if(H.isInstancedBufferGeometry){let Ce=H._maxInstanceCount!==void 0?H._maxInstanceCount:1/0,at=Math.min(H.instanceCount,Ce);lt.renderInstances(We,mt,at)}else lt.render(We,mt)};function Qu(y,N,H){y.transparent===!0&&y.side===kn&&y.forceSinglePass===!1?(y.side=Ht,y.needsUpdate=!0,_a(y,N,H),y.side=si,y.needsUpdate=!0,_a(y,N,H),y.side=kn):_a(y,N,H)}this.compile=function(y,N,H=null){H===null&&(H=y),E=se.get(H),E.init(N),R.push(E),H.traverseVisible(function(B){B.isLight&&B.layers.test(N.layers)&&(E.pushLight(B),B.castShadow&&E.pushShadow(B))}),y!==H&&y.traverseVisible(function(B){B.isLight&&B.layers.test(N.layers)&&(E.pushLight(B),B.castShadow&&E.pushShadow(B))}),E.setupLights();let V=new Set;return y.traverse(function(B){if(!(B.isMesh||B.isPoints||B.isLine||B.isSprite))return;let ae=B.material;if(ae)if(Array.isArray(ae))for(let ge=0;ge<ae.length;ge++){let he=ae[ge];Qu(he,H,B),V.add(he)}else Qu(ae,H,B),V.add(ae)}),E=R.pop(),V},this.compileAsync=function(y,N,H=null){let V=this.compile(y,N,H);return new Promise(B=>{function ae(){if(V.forEach(function(ge){v.get(ge).currentProgram.isReady()&&V.delete(ge)}),V.size===0){B(y);return}setTimeout(ae,10)}Xe.get("KHR_parallel_shader_compile")!==null?ae():setTimeout(ae,10)})};let vc=null;function Jg(y){vc&&vc(y)}function ed(){Ui.stop()}function td(){Ui.start()}let Ui=new Xg;Ui.setAnimationLoop(Jg),typeof self<"u"&&Ui.setContext(self),this.setAnimationLoop=function(y){vc=y,ie.setAnimationLoop(y),y===null?Ui.stop():Ui.start()},ie.addEventListener("sessionstart",ed),ie.addEventListener("sessionend",td),this.render=function(y,N){if(N!==void 0&&N.isCamera!==!0){Pe("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(M===!0)return;let H=ie.enabled===!0&&ie.isPresenting===!0,V=C!==null&&(U===null||H)&&C.begin(x,U);if(y.matrixWorldAutoUpdate===!0&&y.updateMatrixWorld(),N.parent===null&&N.matrixWorldAutoUpdate===!0&&N.updateMatrixWorld(),ie.enabled===!0&&ie.isPresenting===!0&&(C===null||C.isCompositing()===!1)&&(ie.cameraAutoUpdate===!0&&ie.updateCamera(N),N=ie.getCamera()),y.isScene===!0&&y.onBeforeRender(x,y,N,U),E=se.get(y,R.length),E.init(N),R.push(E),ut.multiplyMatrices(N.projectionMatrix,N.matrixWorldInverse),Le.setFromProjectionMatrix(ut,An,N.reversedDepth),Ge=this.localClippingEnabled,fe=ye.init(this.clippingPlanes,Ge),S=K.get(y,T.length),S.init(),T.push(S),ie.enabled===!0&&ie.isPresenting===!0){let ge=x.xr.getDepthSensingMesh();ge!==null&&_c(ge,N,-1/0,x.sortObjects)}_c(y,N,0,x.sortObjects),S.finish(),x.sortObjects===!0&&S.sort(tt,Ze),Me=ie.enabled===!1||ie.isPresenting===!1||ie.hasDepthSensing()===!1,Me&&re.addToRenderList(S,y),this.info.render.frame++,fe===!0&&ye.beginShadows();let B=E.state.shadowsArray;if(Se.render(B,y,N),fe===!0&&ye.endShadows(),this.info.autoReset===!0&&this.info.reset(),(V&&C.hasRenderPass())===!1){let ge=S.opaque,he=S.transmissive;if(E.setupLights(),N.isArrayCamera){let xe=N.cameras;if(he.length>0)for(let be=0,Ie=xe.length;be<Ie;be++){let Te=xe[be];id(ge,he,y,Te)}Me&&re.render(y);for(let be=0,Ie=xe.length;be<Ie;be++){let Te=xe[be];nd(S,y,Te,Te.viewport)}}else he.length>0&&id(ge,he,y,N),Me&&re.render(y),nd(S,y,N)}U!==null&&F===0&&(L.updateMultisampleRenderTarget(U),L.updateRenderTargetMipmap(U)),V&&C.end(x),y.isScene===!0&&y.onAfterRender(x,y,N),me.resetDefaultState(),O=-1,X=null,R.pop(),R.length>0?(E=R[R.length-1],fe===!0&&ye.setGlobalState(x.clippingPlanes,E.state.camera)):E=null,T.pop(),T.length>0?S=T[T.length-1]:S=null};function _c(y,N,H,V){if(y.visible===!1)return;if(y.layers.test(N.layers)){if(y.isGroup)H=y.renderOrder;else if(y.isLOD)y.autoUpdate===!0&&y.update(N);else if(y.isLight)E.pushLight(y),y.castShadow&&E.pushShadow(y);else if(y.isSprite){if(!y.frustumCulled||Le.intersectsSprite(y)){V&&Ae.setFromMatrixPosition(y.matrixWorld).applyMatrix4(ut);let ge=ee.update(y),he=y.material;he.visible&&S.push(y,ge,he,H,Ae.z,null)}}else if((y.isMesh||y.isLine||y.isPoints)&&(!y.frustumCulled||Le.intersectsObject(y))){let ge=ee.update(y),he=y.material;if(V&&(y.boundingSphere!==void 0?(y.boundingSphere===null&&y.computeBoundingSphere(),Ae.copy(y.boundingSphere.center)):(ge.boundingSphere===null&&ge.computeBoundingSphere(),Ae.copy(ge.boundingSphere.center)),Ae.applyMatrix4(y.matrixWorld).applyMatrix4(ut)),Array.isArray(he)){let xe=ge.groups;for(let be=0,Ie=xe.length;be<Ie;be++){let Te=xe[be],We=he[Te.materialIndex];We&&We.visible&&S.push(y,ge,We,H,Ae.z,Te)}}else he.visible&&S.push(y,ge,he,H,Ae.z,null)}}let ae=y.children;for(let ge=0,he=ae.length;ge<he;ge++)_c(ae[ge],N,H,V)}function nd(y,N,H,V){let{opaque:B,transmissive:ae,transparent:ge}=y;E.setupLightsView(H),fe===!0&&ye.setGlobalState(x.clippingPlanes,H),V&&de.viewport(G.copy(V)),B.length>0&&va(B,N,H),ae.length>0&&va(ae,N,H),ge.length>0&&va(ge,N,H),de.buffers.depth.setTest(!0),de.buffers.depth.setMask(!0),de.buffers.color.setMask(!0),de.setPolygonOffset(!1)}function id(y,N,H,V){if((H.isScene===!0?H.overrideMaterial:null)!==null)return;if(E.state.transmissionRenderTarget[V.id]===void 0){let We=Xe.has("EXT_color_buffer_half_float")||Xe.has("EXT_color_buffer_float");E.state.transmissionRenderTarget[V.id]=new an(1,1,{generateMipmaps:!0,type:We?Hn:cn,minFilter:Di,samples:Ye.samples,stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:Je.workingColorSpace})}let ae=E.state.transmissionRenderTarget[V.id],ge=V.viewport||G;ae.setSize(ge.z*x.transmissionResolutionScale,ge.w*x.transmissionResolutionScale);let he=x.getRenderTarget(),xe=x.getActiveCubeFace(),be=x.getActiveMipmapLevel();x.setRenderTarget(ae),x.getClearColor(le),ne=x.getClearAlpha(),ne<1&&x.setClearColor(16777215,.5),x.clear(),Me&&re.render(H);let Ie=x.toneMapping;x.toneMapping=Tn;let Te=V.viewport;if(V.viewport!==void 0&&(V.viewport=void 0),E.setupLightsView(V),fe===!0&&ye.setGlobalState(x.clippingPlanes,V),va(y,H,V),L.updateMultisampleRenderTarget(ae),L.updateRenderTargetMipmap(ae),Xe.has("WEBGL_multisampled_render_to_texture")===!1){let We=!1;for(let ot=0,mt=N.length;ot<mt;ot++){let gt=N[ot],{object:lt,geometry:Ce,material:at,group:Qe}=gt;if(at.side===kn&&lt.layers.test(V.layers)){let jt=at.side;at.side=Ht,at.needsUpdate=!0,rd(lt,H,V,Ce,at,Qe),at.side=jt,at.needsUpdate=!0,We=!0}}We===!0&&(L.updateMultisampleRenderTarget(ae),L.updateRenderTargetMipmap(ae))}x.setRenderTarget(he,xe,be),x.setClearColor(le,ne),Te!==void 0&&(V.viewport=Te),x.toneMapping=Ie}function va(y,N,H){let V=N.isScene===!0?N.overrideMaterial:null;for(let B=0,ae=y.length;B<ae;B++){let ge=y[B],{object:he,geometry:xe,group:be}=ge,Ie=ge.material;Ie.allowOverride===!0&&V!==null&&(Ie=V),he.layers.test(H.layers)&&rd(he,N,H,xe,Ie,be)}}function rd(y,N,H,V,B,ae){y.onBeforeRender(x,N,H,V,B,ae),y.modelViewMatrix.multiplyMatrices(H.matrixWorldInverse,y.matrixWorld),y.normalMatrix.getNormalMatrix(y.modelViewMatrix),B.onBeforeRender(x,N,H,V,y,ae),B.transparent===!0&&B.side===kn&&B.forceSinglePass===!1?(B.side=Ht,B.needsUpdate=!0,x.renderBufferDirect(H,N,V,B,y,ae),B.side=si,B.needsUpdate=!0,x.renderBufferDirect(H,N,V,B,y,ae),B.side=kn):x.renderBufferDirect(H,N,V,B,y,ae),y.onAfterRender(x,N,H,V,B,ae)}function _a(y,N,H){N.isScene!==!0&&(N=we);let V=v.get(y),B=E.state.lights,ae=E.state.shadowsArray,ge=B.state.version,he=_e.getParameters(y,B.state,ae,N,H),xe=_e.getProgramCacheKey(he),be=V.programs;V.environment=y.isMeshStandardMaterial?N.environment:null,V.fog=N.fog,V.envMap=(y.isMeshStandardMaterial?$:q).get(y.envMap||V.environment),V.envMapRotation=V.environment!==null&&y.envMap===null?N.environmentRotation:y.envMapRotation,be===void 0&&(y.addEventListener("dispose",In),be=new Map,V.programs=be);let Ie=be.get(xe);if(Ie!==void 0){if(V.currentProgram===Ie&&V.lightsStateVersion===ge)return ad(y,he),Ie}else he.uniforms=_e.getUniforms(y),y.onBeforeCompile(he,x),Ie=_e.acquireProgram(he,xe),be.set(xe,Ie),V.uniforms=he.uniforms;let Te=V.uniforms;return(!y.isShaderMaterial&&!y.isRawShaderMaterial||y.clipping===!0)&&(Te.clippingPlanes=ye.uniform),ad(y,he),V.needsLights=e0(y),V.lightsStateVersion=ge,V.needsLights&&(Te.ambientLightColor.value=B.state.ambient,Te.lightProbe.value=B.state.probe,Te.directionalLights.value=B.state.directional,Te.directionalLightShadows.value=B.state.directionalShadow,Te.spotLights.value=B.state.spot,Te.spotLightShadows.value=B.state.spotShadow,Te.rectAreaLights.value=B.state.rectArea,Te.ltc_1.value=B.state.rectAreaLTC1,Te.ltc_2.value=B.state.rectAreaLTC2,Te.pointLights.value=B.state.point,Te.pointLightShadows.value=B.state.pointShadow,Te.hemisphereLights.value=B.state.hemi,Te.directionalShadowMap.value=B.state.directionalShadowMap,Te.directionalShadowMatrix.value=B.state.directionalShadowMatrix,Te.spotShadowMap.value=B.state.spotShadowMap,Te.spotLightMatrix.value=B.state.spotLightMatrix,Te.spotLightMap.value=B.state.spotLightMap,Te.pointShadowMap.value=B.state.pointShadowMap,Te.pointShadowMatrix.value=B.state.pointShadowMatrix),V.currentProgram=Ie,V.uniformsList=null,Ie}function sd(y){if(y.uniformsList===null){let N=y.currentProgram.getUniforms();y.uniformsList=ts.seqWithValue(N.seq,y.uniforms)}return y.uniformsList}function ad(y,N){let H=v.get(y);H.outputColorSpace=N.outputColorSpace,H.batching=N.batching,H.batchingColor=N.batchingColor,H.instancing=N.instancing,H.instancingColor=N.instancingColor,H.instancingMorph=N.instancingMorph,H.skinning=N.skinning,H.morphTargets=N.morphTargets,H.morphNormals=N.morphNormals,H.morphColors=N.morphColors,H.morphTargetsCount=N.morphTargetsCount,H.numClippingPlanes=N.numClippingPlanes,H.numIntersection=N.numClipIntersection,H.vertexAlphas=N.vertexAlphas,H.vertexTangents=N.vertexTangents,H.toneMapping=N.toneMapping}function Kg(y,N,H,V,B){N.isScene!==!0&&(N=we),L.resetTextureUnits();let ae=N.fog,ge=V.isMeshStandardMaterial?N.environment:null,he=U===null?x.outputColorSpace:U.isXRRenderTarget===!0?U.texture.colorSpace:ir,xe=(V.isMeshStandardMaterial?$:q).get(V.envMap||ge),be=V.vertexColors===!0&&!!H.attributes.color&&H.attributes.color.itemSize===4,Ie=!!H.attributes.tangent&&(!!V.normalMap||V.anisotropy>0),Te=!!H.morphAttributes.position,We=!!H.morphAttributes.normal,ot=!!H.morphAttributes.color,mt=Tn;V.toneMapped&&(U===null||U.isXRRenderTarget===!0)&&(mt=x.toneMapping);let gt=H.morphAttributes.position||H.morphAttributes.normal||H.morphAttributes.color,lt=gt!==void 0?gt.length:0,Ce=v.get(V),at=E.state.lights;if(fe===!0&&(Ge===!0||y!==X)){let Bt=y===X&&V.id===O;ye.setState(V,y,Bt)}let Qe=!1;V.version===Ce.__version?(Ce.needsLights&&Ce.lightsStateVersion!==at.state.version||Ce.outputColorSpace!==he||B.isBatchedMesh&&Ce.batching===!1||!B.isBatchedMesh&&Ce.batching===!0||B.isBatchedMesh&&Ce.batchingColor===!0&&B.colorTexture===null||B.isBatchedMesh&&Ce.batchingColor===!1&&B.colorTexture!==null||B.isInstancedMesh&&Ce.instancing===!1||!B.isInstancedMesh&&Ce.instancing===!0||B.isSkinnedMesh&&Ce.skinning===!1||!B.isSkinnedMesh&&Ce.skinning===!0||B.isInstancedMesh&&Ce.instancingColor===!0&&B.instanceColor===null||B.isInstancedMesh&&Ce.instancingColor===!1&&B.instanceColor!==null||B.isInstancedMesh&&Ce.instancingMorph===!0&&B.morphTexture===null||B.isInstancedMesh&&Ce.instancingMorph===!1&&B.morphTexture!==null||Ce.envMap!==xe||V.fog===!0&&Ce.fog!==ae||Ce.numClippingPlanes!==void 0&&(Ce.numClippingPlanes!==ye.numPlanes||Ce.numIntersection!==ye.numIntersection)||Ce.vertexAlphas!==be||Ce.vertexTangents!==Ie||Ce.morphTargets!==Te||Ce.morphNormals!==We||Ce.morphColors!==ot||Ce.toneMapping!==mt||Ce.morphTargetsCount!==lt)&&(Qe=!0):(Qe=!0,Ce.__version=V.version);let jt=Ce.currentProgram;Qe===!0&&(jt=_a(V,N,B));let mr=!1,Zt=!1,is=!1,ht=jt.getUniforms(),Gt=Ce.uniforms;if(de.useProgram(jt.program)&&(mr=!0,Zt=!0,is=!0),V.id!==O&&(O=V.id,Zt=!0),mr||X!==y){de.buffers.depth.getReversed()&&y.reversedDepth!==!0&&(y._reversedDepth=!0,y.updateProjectionMatrix()),ht.setValue(P,"projectionMatrix",y.projectionMatrix),ht.setValue(P,"viewMatrix",y.matrixWorldInverse);let Wt=ht.map.cameraPosition;Wt!==void 0&&Wt.setValue(P,Ne.setFromMatrixPosition(y.matrixWorld)),Ye.logarithmicDepthBuffer&&ht.setValue(P,"logDepthBufFC",2/(Math.log(y.far+1)/Math.LN2)),(V.isMeshPhongMaterial||V.isMeshToonMaterial||V.isMeshLambertMaterial||V.isMeshBasicMaterial||V.isMeshStandardMaterial||V.isShaderMaterial)&&ht.setValue(P,"isOrthographic",y.isOrthographicCamera===!0),X!==y&&(X=y,Zt=!0,is=!0)}if(Ce.needsLights&&(at.state.directionalShadowMap.length>0&&ht.setValue(P,"directionalShadowMap",at.state.directionalShadowMap,L),at.state.spotShadowMap.length>0&&ht.setValue(P,"spotShadowMap",at.state.spotShadowMap,L),at.state.pointShadowMap.length>0&&ht.setValue(P,"pointShadowMap",at.state.pointShadowMap,L)),B.isSkinnedMesh){ht.setOptional(P,B,"bindMatrix"),ht.setOptional(P,B,"bindMatrixInverse");let Bt=B.skeleton;Bt&&(Bt.boneTexture===null&&Bt.computeBoneTexture(),ht.setValue(P,"boneTexture",Bt.boneTexture,L))}B.isBatchedMesh&&(ht.setOptional(P,B,"batchingTexture"),ht.setValue(P,"batchingTexture",B._matricesTexture,L),ht.setOptional(P,B,"batchingIdTexture"),ht.setValue(P,"batchingIdTexture",B._indirectTexture,L),ht.setOptional(P,B,"batchingColorTexture"),B._colorsTexture!==null&&ht.setValue(P,"batchingColorTexture",B._colorsTexture,L));let hn=H.morphAttributes;if((hn.position!==void 0||hn.normal!==void 0||hn.color!==void 0)&&He.update(B,H,jt),(Zt||Ce.receiveShadow!==B.receiveShadow)&&(Ce.receiveShadow=B.receiveShadow,ht.setValue(P,"receiveShadow",B.receiveShadow)),V.isMeshGouraudMaterial&&V.envMap!==null&&(Gt.envMap.value=xe,Gt.flipEnvMap.value=xe.isCubeTexture&&xe.isRenderTargetTexture===!1?-1:1),V.isMeshStandardMaterial&&V.envMap===null&&N.environment!==null&&(Gt.envMapIntensity.value=N.environmentIntensity),Gt.dfgLUT!==void 0&&(Gt.dfgLUT.value=Hb()),Zt&&(ht.setValue(P,"toneMappingExposure",x.toneMappingExposure),Ce.needsLights&&Qg(Gt,is),ae&&V.fog===!0&&Re.refreshFogUniforms(Gt,ae),Re.refreshMaterialUniforms(Gt,V,De,ke,E.state.transmissionRenderTarget[y.id]),ts.upload(P,sd(Ce),Gt,L)),V.isShaderMaterial&&V.uniformsNeedUpdate===!0&&(ts.upload(P,sd(Ce),Gt,L),V.uniformsNeedUpdate=!1),V.isSpriteMaterial&&ht.setValue(P,"center",B.center),ht.setValue(P,"modelViewMatrix",B.modelViewMatrix),ht.setValue(P,"normalMatrix",B.normalMatrix),ht.setValue(P,"modelMatrix",B.matrixWorld),V.isShaderMaterial||V.isRawShaderMaterial){let Bt=V.uniformsGroups;for(let Wt=0,xc=Bt.length;Wt<xc;Wt++){let Oi=Bt[Wt];Q.update(Oi,jt),Q.bind(Oi,jt)}}return jt}function Qg(y,N){y.ambientLightColor.needsUpdate=N,y.lightProbe.needsUpdate=N,y.directionalLights.needsUpdate=N,y.directionalLightShadows.needsUpdate=N,y.pointLights.needsUpdate=N,y.pointLightShadows.needsUpdate=N,y.spotLights.needsUpdate=N,y.spotLightShadows.needsUpdate=N,y.rectAreaLights.needsUpdate=N,y.hemisphereLights.needsUpdate=N}function e0(y){return y.isMeshLambertMaterial||y.isMeshToonMaterial||y.isMeshPhongMaterial||y.isMeshStandardMaterial||y.isShadowMaterial||y.isShaderMaterial&&y.lights===!0}this.getActiveCubeFace=function(){return I},this.getActiveMipmapLevel=function(){return F},this.getRenderTarget=function(){return U},this.setRenderTargetTextures=function(y,N,H){let V=v.get(y);V.__autoAllocateDepthBuffer=y.resolveDepthBuffer===!1,V.__autoAllocateDepthBuffer===!1&&(V.__useRenderToTexture=!1),v.get(y.texture).__webglTexture=N,v.get(y.depthTexture).__webglTexture=V.__autoAllocateDepthBuffer?void 0:H,V.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(y,N){let H=v.get(y);H.__webglFramebuffer=N,H.__useDefaultFramebuffer=N===void 0};let t0=P.createFramebuffer();this.setRenderTarget=function(y,N=0,H=0){U=y,I=N,F=H;let V=null,B=!1,ae=!1;if(y){let he=v.get(y);if(he.__useDefaultFramebuffer!==void 0){de.bindFramebuffer(P.FRAMEBUFFER,he.__webglFramebuffer),G.copy(y.viewport),k.copy(y.scissor),Z=y.scissorTest,de.viewport(G),de.scissor(k),de.setScissorTest(Z),O=-1;return}else if(he.__webglFramebuffer===void 0)L.setupRenderTarget(y);else if(he.__hasExternalTextures)L.rebindTextures(y,v.get(y.texture).__webglTexture,v.get(y.depthTexture).__webglTexture);else if(y.depthBuffer){let Ie=y.depthTexture;if(he.__boundDepthTexture!==Ie){if(Ie!==null&&v.has(Ie)&&(y.width!==Ie.image.width||y.height!==Ie.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");L.setupDepthRenderbuffer(y)}}let xe=y.texture;(xe.isData3DTexture||xe.isDataArrayTexture||xe.isCompressedArrayTexture)&&(ae=!0);let be=v.get(y).__webglFramebuffer;y.isWebGLCubeRenderTarget?(Array.isArray(be[N])?V=be[N][H]:V=be[N],B=!0):y.samples>0&&L.useMultisampledRTT(y)===!1?V=v.get(y).__webglMultisampledFramebuffer:Array.isArray(be)?V=be[H]:V=be,G.copy(y.viewport),k.copy(y.scissor),Z=y.scissorTest}else G.copy(Y).multiplyScalar(De).floor(),k.copy(J).multiplyScalar(De).floor(),Z=pe;if(H!==0&&(V=t0),de.bindFramebuffer(P.FRAMEBUFFER,V)&&de.drawBuffers(y,V),de.viewport(G),de.scissor(k),de.setScissorTest(Z),B){let he=v.get(y.texture);P.framebufferTexture2D(P.FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_CUBE_MAP_POSITIVE_X+N,he.__webglTexture,H)}else if(ae){let he=N;for(let xe=0;xe<y.textures.length;xe++){let be=v.get(y.textures[xe]);P.framebufferTextureLayer(P.FRAMEBUFFER,P.COLOR_ATTACHMENT0+xe,be.__webglTexture,H,he)}}else if(y!==null&&H!==0){let he=v.get(y.texture);P.framebufferTexture2D(P.FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_2D,he.__webglTexture,H)}O=-1},this.readRenderTargetPixels=function(y,N,H,V,B,ae,ge,he=0){if(!(y&&y.isWebGLRenderTarget)){Pe("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let xe=v.get(y).__webglFramebuffer;if(y.isWebGLCubeRenderTarget&&ge!==void 0&&(xe=xe[ge]),xe){de.bindFramebuffer(P.FRAMEBUFFER,xe);try{let be=y.textures[he],Ie=be.format,Te=be.type;if(!Ye.textureFormatReadable(Ie)){Pe("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!Ye.textureTypeReadable(Te)){Pe("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}N>=0&&N<=y.width-V&&H>=0&&H<=y.height-B&&(y.textures.length>1&&P.readBuffer(P.COLOR_ATTACHMENT0+he),P.readPixels(N,H,V,B,te.convert(Ie),te.convert(Te),ae))}finally{let be=U!==null?v.get(U).__webglFramebuffer:null;de.bindFramebuffer(P.FRAMEBUFFER,be)}}},this.readRenderTargetPixelsAsync=async function(y,N,H,V,B,ae,ge,he=0){if(!(y&&y.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let xe=v.get(y).__webglFramebuffer;if(y.isWebGLCubeRenderTarget&&ge!==void 0&&(xe=xe[ge]),xe)if(N>=0&&N<=y.width-V&&H>=0&&H<=y.height-B){de.bindFramebuffer(P.FRAMEBUFFER,xe);let be=y.textures[he],Ie=be.format,Te=be.type;if(!Ye.textureFormatReadable(Ie))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!Ye.textureTypeReadable(Te))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");let We=P.createBuffer();P.bindBuffer(P.PIXEL_PACK_BUFFER,We),P.bufferData(P.PIXEL_PACK_BUFFER,ae.byteLength,P.STREAM_READ),y.textures.length>1&&P.readBuffer(P.COLOR_ATTACHMENT0+he),P.readPixels(N,H,V,B,te.convert(Ie),te.convert(Te),0);let ot=U!==null?v.get(U).__webglFramebuffer:null;de.bindFramebuffer(P.FRAMEBUFFER,ot);let mt=P.fenceSync(P.SYNC_GPU_COMMANDS_COMPLETE,0);return P.flush(),await yg(P,mt,4),P.bindBuffer(P.PIXEL_PACK_BUFFER,We),P.getBufferSubData(P.PIXEL_PACK_BUFFER,0,ae),P.deleteBuffer(We),P.deleteSync(mt),ae}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(y,N=null,H=0){let V=Math.pow(2,-H),B=Math.floor(y.image.width*V),ae=Math.floor(y.image.height*V),ge=N!==null?N.x:0,he=N!==null?N.y:0;L.setTexture2D(y,0),P.copyTexSubImage2D(P.TEXTURE_2D,H,0,0,ge,he,B,ae),de.unbindTexture()};let n0=P.createFramebuffer(),i0=P.createFramebuffer();this.copyTextureToTexture=function(y,N,H=null,V=null,B=0,ae=null){ae===null&&(B!==0?(qr("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),ae=B,B=0):ae=0);let ge,he,xe,be,Ie,Te,We,ot,mt,gt=y.isCompressedTexture?y.mipmaps[ae]:y.image;if(H!==null)ge=H.max.x-H.min.x,he=H.max.y-H.min.y,xe=H.isBox3?H.max.z-H.min.z:1,be=H.min.x,Ie=H.min.y,Te=H.isBox3?H.min.z:0;else{let hn=Math.pow(2,-B);ge=Math.floor(gt.width*hn),he=Math.floor(gt.height*hn),y.isDataArrayTexture?xe=gt.depth:y.isData3DTexture?xe=Math.floor(gt.depth*hn):xe=1,be=0,Ie=0,Te=0}V!==null?(We=V.x,ot=V.y,mt=V.z):(We=0,ot=0,mt=0);let lt=te.convert(N.format),Ce=te.convert(N.type),at;N.isData3DTexture?(L.setTexture3D(N,0),at=P.TEXTURE_3D):N.isDataArrayTexture||N.isCompressedArrayTexture?(L.setTexture2DArray(N,0),at=P.TEXTURE_2D_ARRAY):(L.setTexture2D(N,0),at=P.TEXTURE_2D),P.pixelStorei(P.UNPACK_FLIP_Y_WEBGL,N.flipY),P.pixelStorei(P.UNPACK_PREMULTIPLY_ALPHA_WEBGL,N.premultiplyAlpha),P.pixelStorei(P.UNPACK_ALIGNMENT,N.unpackAlignment);let Qe=P.getParameter(P.UNPACK_ROW_LENGTH),jt=P.getParameter(P.UNPACK_IMAGE_HEIGHT),mr=P.getParameter(P.UNPACK_SKIP_PIXELS),Zt=P.getParameter(P.UNPACK_SKIP_ROWS),is=P.getParameter(P.UNPACK_SKIP_IMAGES);P.pixelStorei(P.UNPACK_ROW_LENGTH,gt.width),P.pixelStorei(P.UNPACK_IMAGE_HEIGHT,gt.height),P.pixelStorei(P.UNPACK_SKIP_PIXELS,be),P.pixelStorei(P.UNPACK_SKIP_ROWS,Ie),P.pixelStorei(P.UNPACK_SKIP_IMAGES,Te);let ht=y.isDataArrayTexture||y.isData3DTexture,Gt=N.isDataArrayTexture||N.isData3DTexture;if(y.isDepthTexture){let hn=v.get(y),Bt=v.get(N),Wt=v.get(hn.__renderTarget),xc=v.get(Bt.__renderTarget);de.bindFramebuffer(P.READ_FRAMEBUFFER,Wt.__webglFramebuffer),de.bindFramebuffer(P.DRAW_FRAMEBUFFER,xc.__webglFramebuffer);for(let Oi=0;Oi<xe;Oi++)ht&&(P.framebufferTextureLayer(P.READ_FRAMEBUFFER,P.COLOR_ATTACHMENT0,v.get(y).__webglTexture,B,Te+Oi),P.framebufferTextureLayer(P.DRAW_FRAMEBUFFER,P.COLOR_ATTACHMENT0,v.get(N).__webglTexture,ae,mt+Oi)),P.blitFramebuffer(be,Ie,ge,he,We,ot,ge,he,P.DEPTH_BUFFER_BIT,P.NEAREST);de.bindFramebuffer(P.READ_FRAMEBUFFER,null),de.bindFramebuffer(P.DRAW_FRAMEBUFFER,null)}else if(B!==0||y.isRenderTargetTexture||v.has(y)){let hn=v.get(y),Bt=v.get(N);de.bindFramebuffer(P.READ_FRAMEBUFFER,n0),de.bindFramebuffer(P.DRAW_FRAMEBUFFER,i0);for(let Wt=0;Wt<xe;Wt++)ht?P.framebufferTextureLayer(P.READ_FRAMEBUFFER,P.COLOR_ATTACHMENT0,hn.__webglTexture,B,Te+Wt):P.framebufferTexture2D(P.READ_FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_2D,hn.__webglTexture,B),Gt?P.framebufferTextureLayer(P.DRAW_FRAMEBUFFER,P.COLOR_ATTACHMENT0,Bt.__webglTexture,ae,mt+Wt):P.framebufferTexture2D(P.DRAW_FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_2D,Bt.__webglTexture,ae),B!==0?P.blitFramebuffer(be,Ie,ge,he,We,ot,ge,he,P.COLOR_BUFFER_BIT,P.NEAREST):Gt?P.copyTexSubImage3D(at,ae,We,ot,mt+Wt,be,Ie,ge,he):P.copyTexSubImage2D(at,ae,We,ot,be,Ie,ge,he);de.bindFramebuffer(P.READ_FRAMEBUFFER,null),de.bindFramebuffer(P.DRAW_FRAMEBUFFER,null)}else Gt?y.isDataTexture||y.isData3DTexture?P.texSubImage3D(at,ae,We,ot,mt,ge,he,xe,lt,Ce,gt.data):N.isCompressedArrayTexture?P.compressedTexSubImage3D(at,ae,We,ot,mt,ge,he,xe,lt,gt.data):P.texSubImage3D(at,ae,We,ot,mt,ge,he,xe,lt,Ce,gt):y.isDataTexture?P.texSubImage2D(P.TEXTURE_2D,ae,We,ot,ge,he,lt,Ce,gt.data):y.isCompressedTexture?P.compressedTexSubImage2D(P.TEXTURE_2D,ae,We,ot,gt.width,gt.height,lt,gt.data):P.texSubImage2D(P.TEXTURE_2D,ae,We,ot,ge,he,lt,Ce,gt);P.pixelStorei(P.UNPACK_ROW_LENGTH,Qe),P.pixelStorei(P.UNPACK_IMAGE_HEIGHT,jt),P.pixelStorei(P.UNPACK_SKIP_PIXELS,mr),P.pixelStorei(P.UNPACK_SKIP_ROWS,Zt),P.pixelStorei(P.UNPACK_SKIP_IMAGES,is),ae===0&&N.generateMipmaps&&P.generateMipmap(at),de.unbindTexture()},this.initRenderTarget=function(y){v.get(y).__webglFramebuffer===void 0&&L.setupRenderTarget(y)},this.initTexture=function(y){y.isCubeTexture?L.setTextureCube(y,0):y.isData3DTexture?L.setTexture3D(y,0):y.isDataArrayTexture||y.isCompressedArrayTexture?L.setTexture2DArray(y,0):L.setTexture2D(y,0),de.unbindTexture()},this.resetState=function(){I=0,F=0,U=null,de.reset(),me.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return An}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;let t=this.getContext();t.drawingBufferColorSpace=Je._getDrawingBufferColorSpace(e),t.unpackColorSpace=Je._getUnpackColorSpace()}};var Wb=["glCanvas"],Xb=["vigCanvas"],pr=0,Et=1,Ot=2,Ku=[[.831,.627,.29],[.788,.529,.231],[.859,.58,.263],[.91,.663,.31],[.722,.478,.204],[.941,.745,.416],[.659,.431,.176],[.859,.635,.333],[.769,.533,.224],[.878,.678,.369]],qb=`
